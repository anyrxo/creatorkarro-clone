...
export const metadata: Metadata = {
  title: 'Top digital products Course | New York | IImagined.ai',
  description: 'Master digital products course in New York. Join 275+ successful students with our proven system. 90% success rate, lifetime access.',
  keywords: 'top digital-products-course new-york, digital-products-course course new-york, digital-products-course training new-york, learn digital-products-course new-york, new-york digital-products-course expert, online digital-products-course course',
  openGraph: {
    title: 'Top digital products Course in New York',
    description: 'Master digital products course in New York. Join 275+ successful students with our proven system. 90% success rate, lifetime access.',
    images: [{ url: '/og-geo-top-digital-products-course-new-york.jpg', width: 1200, height: 630 }]
  }
}

export default function TopDigitalProductsCourseNewYorkPage() {
  ...
  const jsonLd = {
    ...
    '@type': ['Service', 'Course'],
    'name': 'Top digital products course Training in New York',
    ...
    <div className="min-h-screen bg-dark">
      ...
      <BreadcrumbSchema 
        items={[
          ...
          { name: 'New York', url: 'https://iimagined.ai/top-digital-products-course-new-york' }
        ]}
      />
        ...
        <div className="container mx-auto max-w-6xl relative z-10">
          ...
          >
            <div className="flex items-center justify-center gap-2 mb-6">
              ...
              <span className="text-blue-400 font-semibold">New York</span>
            </div>
            
            <h1 className="text-5xl md:text-7xl font-bold text-white mb-6 leading-tight">
              Top digital products Course
            </h1>
            
            <p className="text-xl md:text-2xl text-zinc-300 mb-8 max-w-4xl mx-auto leading-relaxed">
              Join 275+ entrepreneurs in New York who have mastered digital products course with our battle-tested strategies and achieved real results.
            </p>
          ...
          >
            <div className="p-6 bg-zinc-800/50 rounded-2xl">
              <div className="text-4xl font-bold text-blue-400 mb-2">
                <NumberTicker value={275} />+
              </div>
              <p className="text-zinc-300">Students in New York</p>
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-4xl font-bold text-center mb-12">
              Why New York Entrepreneurs Choose IImagined.ai
            </h2>
            
            <div className="grid md:grid-cols-2 gap-8">
              {[
                'Local success stories from New York students',
      ...
      <section className="py-20 bg-gradient-to-r from-blue-900/20 to-purple-900/20">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-4xl font-bold mb-6">
            Ready to Start Your Success Story in New York?
          </h2>
          
          <p className="text-xl text-zinc-300 mb-8 max-w-2xl mx-auto">
            Join hundreds of successful entrepreneurs in New York who have transformed their businesses with our proven system.
          </p>
