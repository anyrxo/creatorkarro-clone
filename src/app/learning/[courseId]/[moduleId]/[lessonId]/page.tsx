...
import { ArrowRight, CheckCircle, Download, FileText, ChevronLeft, Sparkles, Save, Cloud, CloudOff, Lock, Crown } from 'lucide-react'
import Link from 'next/link'
import { useCourse } from '@/context/CourseContext'
import { motion, AnimatePresence } from 'framer-motion'
import Confetti from '@/components/learning/Confetti'
import LockedLessonUI from '@/components/learning/LockedLessonUI'
...
export default function LessonPage() {
    ...
    const { markLessonComplete, isLessonComplete, isLessonLocked } = useCourse()
    ...
    return (
        <div className="p-6 md:p-10 max-w-6xl mx-auto relative">
            ...
            {/* Lesson Content - Only show if not locked */}
            {!locked && (
                <>
