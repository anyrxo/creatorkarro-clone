...
export const metadata: Metadata = {
  ...
  description: 'Master ai automation course in Los Angeles. Join 156+ successful students with our proven system. 90% success rate, lifetime access.',
  keywords: 'best ai-automation-course los-angeles, ai-automation-course course los-angeles, ai-automation-course training los-angeles, learn ai-automation-course los-angeles, los-angeles ai-automation-course expert, online ai-automation-course course',
  openGraph: {
        ...
        <div className="container mx-auto max-w-6xl relative z-10">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-zinc-300 mb-8 max-w-4xl mx-auto leading-relaxed">
              Join 156+ entrepreneurs in Los Angeles who have mastered ai automation course with our battle-tested strategies and achieved real results.
            </p>
