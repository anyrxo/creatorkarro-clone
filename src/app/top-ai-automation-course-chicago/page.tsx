...
export const metadata: Metadata = {
  ...
  description: 'Master ai automation course in Chicago. Join 336+ successful students with our proven system. 90% success rate, lifetime access.',
  keywords: 'top ai-automation-course chicago, ai-automation-course course chicago, ai-automation-course training chicago, learn ai-automation-course chicago, chicago ai-automation-course expert, online ai-automation-course course',
  openGraph: {
        ...
        <div className="container mx-auto max-w-6xl relative z-10">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-zinc-300 mb-8 max-w-4xl mx-auto leading-relaxed">
              Join 336+ entrepreneurs in Chicago who have mastered ai automation course with our battle-tested strategies and achieved real results.
            </p>
