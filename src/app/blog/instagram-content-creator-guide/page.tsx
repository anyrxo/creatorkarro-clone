...
export const metadata = {
  ...
  keywords: ["instagram content creator guide","instagram content creator guide guide","instagram content creator guide 2025","instagram content creator guide course","instagram content creator guide training","instagram","instagram content creator guide","course","training","guide","2025"],
  ...
  openGraph: {
    title: "Instagram Content Creator Guide: Expert Guide 2025",
    description: "instagram content creator guide guide, instagram content creator guide tutorial, instagram content creator guide course - Expert training from the creators of I",
    url: "https://iimagined.ai/blog/instagram-content-creator-guide",
    siteName: "IImagined.ai",
    type: "article",
    publishedTime: "2025-08-05T10:00:00.000Z",
    modifiedTime: "2025-08-05T08:27:05.624Z",
    authors: ["IImagined.ai Expert Team"],
    tags: ["instagram content creator guide","instagram content creator guide guide","instagram content creator guide 2025","instagram content creator guide course","instagram content creator guide training","instagram"],
    images: [{
      url: "https://iimagined.ai/images/instagram-content-creator-guide-og.jpg",
      width: 1200,
      height: 630,
      alt: "Instagram Content Creator Guide: Expert Guide 2025",
      type: "image/jpeg"
    }],
    locale: "en_US"
  },
  ...
  alternates: {
    canonical: "https://iimagined.ai/blog/instagram-content-creator-guide"
  }
}
          ...
          <div className="prose prose-invert prose-lg max-w-none">
            ...
            <div className="bg-gradient-to-r from-zinc-900/50 to-zinc-800/50 rounded-2xl p-8 mb-12 border border-zinc-700/50 backdrop-blur-sm">
              ...
              <div className="flex flex-wrap gap-3">
                <span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#instagram content creator guide</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#instagram content creator guide guide</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#instagram content creator guide 2025</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#instagram content creator guide course</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#instagram content creator guide training</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#instagram</span>
              </div>
            </div>
