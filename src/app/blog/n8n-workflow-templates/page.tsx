...
export const metadata = {
  ...
  keywords: ["n8n workflow templates","n8n workflow templates guide","n8n workflow templates 2025","n8n workflow templates course","n8n workflow templates training","n8n","n8n workflow templates","course","training","guide","2025"],
  ...
  openGraph: {
    title: "N8n Workflow Templates: Expert Guide 2025",
    description: "n8n workflow templates guide, n8n workflow templates tutorial, n8n workflow templates course - Expert training from the creators of N8N Automation Hub with 45K+",
    url: "https://iimagined.ai/blog/n8n-workflow-templates",
    siteName: "IImagined.ai",
    type: "article",
    publishedTime: "2025-08-05T10:00:00.000Z",
    modifiedTime: "2025-08-05T08:27:05.631Z",
    authors: ["IImagined.ai Expert Team"],
    tags: ["n8n workflow templates","n8n workflow templates guide","n8n workflow templates 2025","n8n workflow templates course","n8n workflow templates training","n8n"],
    images: [{
      url: "https://iimagined.ai/images/n8n-workflow-templates-og.jpg",
      width: 1200,
      height: 630,
      alt: "N8n Workflow Templates: Expert Guide 2025",
      type: "image/jpeg"
    }],
    locale: "en_US"
  },
  ...
  alternates: {
    canonical: "https://iimagined.ai/blog/n8n-workflow-templates"
  }
}
          ...
          <div className="prose prose-invert prose-lg max-w-none">
            ...
            <div className="bg-gradient-to-r from-zinc-900/50 to-zinc-800/50 rounded-2xl p-8 mb-12 border border-zinc-700/50 backdrop-blur-sm">
              ...
              <div className="flex flex-wrap gap-3">
                <span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#n8n workflow templates</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#n8n workflow templates guide</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#n8n workflow templates 2025</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#n8n workflow templates course</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#n8n workflow templates training</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#n8n</span>
              </div>
            </div>
