...
export const metadata = {
  ...
  keywords: ["instagram engagement pods","instagram engagement pods guide","instagram engagement pods 2025","instagram engagement pods course","instagram engagement pods training","instagram","instagram engagement pods","course","training","guide","2025"],
  ...
  openGraph: {
    title: "Instagram Engagement Pods: Expert Guide 2025",
    description: "instagram engagement pods guide, instagram engagement pods tutorial, instagram engagement pods course - Expert training from the creators of Instagram Growth Ac",
    url: "https://iimagined.ai/blog/instagram-engagement-pods",
    siteName: "IImagined.ai",
    type: "article",
    publishedTime: "2025-08-05T10:00:00.000Z",
    modifiedTime: "2025-08-05T08:27:05.626Z",
    authors: ["IImagined.ai Expert Team"],
    tags: ["instagram engagement pods","instagram engagement pods guide","instagram engagement pods 2025","instagram engagement pods course","instagram engagement pods training","instagram"],
    images: [{
      url: "https://iimagined.ai/images/instagram-engagement-pods-og.jpg",
      width: 1200,
      height: 630,
      alt: "Instagram Engagement Pods: Expert Guide 2025",
      type: "image/jpeg"
    }],
    locale: "en_US"
  },
  ...
  alternates: {
    canonical: "https://iimagined.ai/blog/instagram-engagement-pods"
  }
}
          ...
          <div className="prose prose-invert prose-lg max-w-none">
            ...
            <div className="bg-gradient-to-r from-zinc-900/50 to-zinc-800/50 rounded-2xl p-8 mb-12 border border-zinc-700/50 backdrop-blur-sm">
              ...
              <div className="flex flex-wrap gap-3">
                <span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#instagram engagement pods</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#instagram engagement pods guide</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#instagram engagement pods 2025</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#instagram engagement pods course</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#instagram engagement pods training</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#instagram</span>
              </div>
            </div>
