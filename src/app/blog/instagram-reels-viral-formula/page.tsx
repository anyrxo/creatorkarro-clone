...
export const metadata = {
  ...
  keywords: ["instagram reels viral formula","instagram reels viral formula guide","instagram reels viral formula 2025","instagram reels viral formula course","instagram reels viral formula training","instagram","instagram reels viral formula","course","training","guide","2025"],
  ...
  openGraph: {
    title: "Instagram Reels Viral Formula: Expert Guide 2025",
    description: "instagram reels viral formula guide, instagram reels viral formula tutorial, instagram reels viral formula course - Expert training from the creators of Instagr",
    url: "https://iimagined.ai/blog/instagram-reels-viral-formula",
    siteName: "IImagined.ai",
    type: "article",
    publishedTime: "2025-08-05T10:00:00.000Z",
    modifiedTime: "2025-08-05T08:27:05.624Z",
    authors: ["IImagined.ai Expert Team"],
    tags: ["instagram reels viral formula","instagram reels viral formula guide","instagram reels viral formula 2025","instagram reels viral formula course","instagram reels viral formula training","instagram"],
    images: [{
      url: "https://iimagined.ai/images/instagram-reels-viral-formula-og.jpg",
      width: 1200,
      height: 630,
      alt: "Instagram Reels Viral Formula: Expert Guide 2025",
      type: "image/jpeg"
    }],
    locale: "en_US"
  },
  ...
  alternates: {
    canonical: "https://iimagined.ai/blog/instagram-reels-viral-formula"
  }
}
          ...
          <div className="prose prose-invert prose-lg max-w-none">
            ...
            <div className="bg-gradient-to-r from-zinc-900/50 to-zinc-800/50 rounded-2xl p-8 mb-12 border border-zinc-700/50 backdrop-blur-sm">
              ...
              <div className="flex flex-wrap gap-3">
                <span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#instagram reels viral formula</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#instagram reels viral formula guide</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#instagram reels viral formula 2025</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#instagram reels viral formula course</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#instagram reels viral formula training</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#instagram</span>
              </div>
            </div>
