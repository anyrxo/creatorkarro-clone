      ...
      <article className="py-20 px-4">
        <div className="container mx-auto max-w-4xl">
          ...
          <section className="mt-16 text-center bg-gradient-to-r from-blue-900/20 to-cyan-900/20 rounded-2xl p-8 border border-blue-500/20">
            <h2 className="text-3xl font-bold mb-4">Master API Automation & Integration</h2>
            <p className="text-xl text-zinc-300 mb-6">
              Learn the complete automation workflows that successful businesses use to connect their tools, eliminate manual work, and scale operations efficiently.
            </p>
            <Link
              href="/courses"
