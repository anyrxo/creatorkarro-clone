...
export const metadata = {
  ...
  description: "Vectorize All In One Rag Platform - comprehensive strategies, tools, and techniques for 2026",
  keywords: ["vectorize", "all", "one", "rag", "platform", "vectorize 2026", "vectorize all one rag platform", "automation", "AI tools", "business growth", "productivity", "2026 strategies"],
