...
await browser.close();`}
            ...
            {/* CTA Section */}
            <div className="bg-gradient-to-br from-indigo-900/40 via-purple-900/40 to-pink-900/40 rounded-2xl p-8 md:p-12 text-center border border-indigo-500/30">
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
                Ready to Master Web Scraping Automation?
              </h2>
              <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
                Learn how to build automated data extraction systems that provide competitive intelligence, generate leads, and power data-driven business decisions.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                <Link
                  href="/courses/ai-automations"
                  className="inline-flex items-center gap-2 bg-gradient-to-r from-indigo-600 to-purple-600 text-white px-8 py-4 rounded-lg font-semibold hover:from-indigo-700 hover:to-purple-700 transition-all shadow-lg hover:shadow-indigo-500/50"
                >
