...
export const metadata = {
  ...
  keywords: ["comfyui model training","comfyui model training guide","comfyui model training 2025","comfyui model training course","comfyui model training training","comfyui","comfyui model training","course","training","guide","2025"],
  ...
  openGraph: {
    title: "Comfyui Model Training: Expert Guide 2025",
    description: "comfyui model training guide, comfyui model training tutorial, comfyui model training course - Expert training from the creators of ComfyUI Pro Training with 32",
    url: "https://iimagined.ai/blog/comfyui-model-training",
    siteName: "IImagined.ai",
    type: "article",
    publishedTime: "2025-08-05T10:00:00.000Z",
    modifiedTime: "2025-08-05T08:27:05.633Z",
    authors: ["IImagined.ai Expert Team"],
    tags: ["comfyui model training","comfyui model training guide","comfyui model training 2025","comfyui model training course","comfyui model training training","comfyui"],
    images: [{
      url: "https://iimagined.ai/images/comfyui-model-training-og.jpg",
      width: 1200,
      height: 630,
      alt: "Comfyui Model Training: Expert Guide 2025",
      type: "image/jpeg"
    }],
    locale: "en_US"
  },
  ...
  alternates: {
    canonical: "https://iimagined.ai/blog/comfyui-model-training"
  }
}
          ...
          <div className="prose prose-invert prose-lg max-w-none">
            ...
            <div className="bg-gradient-to-r from-zinc-900/50 to-zinc-800/50 rounded-2xl p-8 mb-12 border border-zinc-700/50 backdrop-blur-sm">
              ...
              <div className="flex flex-wrap gap-3">
                <span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#comfyui model training</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#comfyui model training guide</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#comfyui model training 2025</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#comfyui model training course</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#comfyui model training training</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#comfyui</span>
              </div>
            </div>
