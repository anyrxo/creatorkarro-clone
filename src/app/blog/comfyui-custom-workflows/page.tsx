...
export const metadata = {
  ...
  keywords: ["comfyui custom workflows","comfyui custom workflows guide","comfyui custom workflows 2025","comfyui custom workflows course","comfyui custom workflows training","comfyui","comfyui custom workflows","course","training","guide","2025"],
  ...
  openGraph: {
    title: "Comfyui Custom Workflows: Expert Guide 2025",
    description: "comfyui custom workflows guide, comfyui custom workflows tutorial, comfyui custom workflows course - Expert training from the creators of N8N Automation Hub wit",
    url: "https://iimagined.ai/blog/comfyui-custom-workflows",
    siteName: "IImagined.ai",
    type: "article",
    publishedTime: "2025-08-05T10:00:00.000Z",
    modifiedTime: "2025-08-05T08:27:05.632Z",
    authors: ["IImagined.ai Expert Team"],
    tags: ["comfyui custom workflows","comfyui custom workflows guide","comfyui custom workflows 2025","comfyui custom workflows course","comfyui custom workflows training","comfyui"],
    images: [{
      url: "https://iimagined.ai/images/comfyui-custom-workflows-og.jpg",
      width: 1200,
      height: 630,
      alt: "Comfyui Custom Workflows: Expert Guide 2025",
      type: "image/jpeg"
    }],
    locale: "en_US"
  },
  ...
  alternates: {
    canonical: "https://iimagined.ai/blog/comfyui-custom-workflows"
  }
}
          ...
          <div className="prose prose-invert prose-lg max-w-none">
            ...
            <div className="bg-gradient-to-r from-zinc-900/50 to-zinc-800/50 rounded-2xl p-8 mb-12 border border-zinc-700/50 backdrop-blur-sm">
              ...
              <div className="flex flex-wrap gap-3">
                <span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#comfyui custom workflows</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#comfyui custom workflows guide</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#comfyui custom workflows 2025</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#comfyui custom workflows course</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#comfyui custom workflows training</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#comfyui</span>
              </div>
            </div>
