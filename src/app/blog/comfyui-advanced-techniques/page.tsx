...
export const metadata = {
  ...
  keywords: ["comfyui advanced techniques","comfyui advanced techniques guide","comfyui advanced techniques 2025","comfyui advanced techniques course","comfyui advanced techniques training","comfyui","comfyui advanced techniques","course","training","guide","2025"],
  ...
  openGraph: {
    title: "Comfyui Advanced Techniques: Expert Guide 2025",
    description: "comfyui advanced techniques guide, comfyui advanced techniques tutorial, comfyui advanced techniques course - Expert training from the creators of ComfyUI Pro T",
    url: "https://iimagined.ai/blog/comfyui-advanced-techniques",
    siteName: "IImagined.ai",
    type: "article",
    publishedTime: "2025-08-05T10:00:00.000Z",
    modifiedTime: "2025-08-05T08:27:05.635Z",
    authors: ["IImagined.ai Expert Team"],
    tags: ["comfyui advanced techniques","comfyui advanced techniques guide","comfyui advanced techniques 2025","comfyui advanced techniques course","comfyui advanced techniques training","comfyui"],
    images: [{
      url: "https://iimagined.ai/images/comfyui-advanced-techniques-og.jpg",
      width: 1200,
      height: 630,
      alt: "Comfyui Advanced Techniques: Expert Guide 2025",
      type: "image/jpeg"
    }],
    locale: "en_US"
  },
  ...
  alternates: {
    canonical: "https://iimagined.ai/blog/comfyui-advanced-techniques"
  }
}
          ...
          <div className="prose prose-invert prose-lg max-w-none">
            ...
            <div className="bg-gradient-to-r from-zinc-900/50 to-zinc-800/50 rounded-2xl p-8 mb-12 border border-zinc-700/50 backdrop-blur-sm">
              ...
              <div className="flex flex-wrap gap-3">
                <span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#comfyui advanced techniques</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#comfyui advanced techniques guide</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#comfyui advanced techniques 2025</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#comfyui advanced techniques course</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#comfyui advanced techniques training</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#comfyui</span>
              </div>
            </div>
