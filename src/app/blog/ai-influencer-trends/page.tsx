  ...
  return (
    <div className="min-h-screen bg-dark">
      ...
      <section 
        ...
        className={`section-spacing scroll-fade-up ${trendsAnimation.isVisible ? 'visible' : ''}`}
      >
      ...
      <section 
        ...
        className={`section-spacing bg-zinc-900 scroll-fade-up ${futureAnimation.isVisible ? 'visible' : ''}`}
      >
