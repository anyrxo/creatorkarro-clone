...
export const metadata = {
  ...
  keywords: ["n8n api integrations","n8n api integrations guide","n8n api integrations 2025","n8n api integrations course","n8n api integrations training","n8n","n8n api integrations","course","training","guide","2025"],
  ...
  openGraph: {
    title: "N8n Api Integrations: Expert Guide 2025",
    description: "n8n api integrations guide, n8n api integrations tutorial, n8n api integrations course - Expert training from the creators of N8N Automation Hub with 45K+ stude",
    url: "https://iimagined.ai/blog/n8n-api-integrations",
    siteName: "IImagined.ai",
    type: "article",
    publishedTime: "2025-08-05T10:00:00.000Z",
    modifiedTime: "2025-08-05T08:27:05.629Z",
    authors: ["IImagined.ai Expert Team"],
    tags: ["n8n api integrations","n8n api integrations guide","n8n api integrations 2025","n8n api integrations course","n8n api integrations training","n8n"],
    images: [{
      url: "https://iimagined.ai/images/n8n-api-integrations-og.jpg",
      width: 1200,
      height: 630,
      alt: "N8n Api Integrations: Expert Guide 2025",
      type: "image/jpeg"
    }],
    locale: "en_US"
  },
  ...
  alternates: {
    canonical: "https://iimagined.ai/blog/n8n-api-integrations"
  }
}
          ...
          <div className="prose prose-invert prose-lg max-w-none">
            ...
            <div className="bg-gradient-to-r from-zinc-900/50 to-zinc-800/50 rounded-2xl p-8 mb-12 border border-zinc-700/50 backdrop-blur-sm">
              ...
              <div className="flex flex-wrap gap-3">
                <span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#n8n api integrations</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#n8n api integrations guide</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#n8n api integrations 2025</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#n8n api integrations course</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#n8n api integrations training</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#n8n</span>
              </div>
            </div>
