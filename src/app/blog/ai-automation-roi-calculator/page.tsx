...
export const metadata = {
  ...
  keywords: ["ai automation ROI calculator","ai automation ROI calculator guide","ai automation ROI calculator 2025","ai automation ROI calculator course","ai automation ROI calculator training","ai","ai automation ROI calculator","course","training","guide","2025"],
  ...
  openGraph: {
    title: "Ai Automation ROI Calculator: Expert Guide 2025",
    description: "ai automation ROI calculator guide, ai automation ROI calculator tutorial, ai automation ROI calculator course - Expert training from the creators of AI Automat",
    url: "https://iimagined.ai/blog/ai-automation-roi-calculator",
    siteName: "IImagined.ai",
    type: "article",
    publishedTime: "2025-08-05T10:00:00.000Z",
    modifiedTime: "2025-08-05T08:27:05.620Z",
    authors: ["IImagined.ai Expert Team"],
    tags: ["ai automation ROI calculator","ai automation ROI calculator guide","ai automation ROI calculator 2025","ai automation ROI calculator course","ai automation ROI calculator training","ai"],
    images: [{
      url: "https://iimagined.ai/images/ai-automation-roi-calculator-og.jpg",
      width: 1200,
      height: 630,
      alt: "Ai Automation ROI Calculator: Expert Guide 2025",
      type: "image/jpeg"
    }],
    locale: "en_US"
  },
  ...
  alternates: {
    canonical: "https://iimagined.ai/blog/ai-automation-roi-calculator"
  }
}
          ...
          <div className="prose prose-invert prose-lg max-w-none">
            ...
            <div className="bg-gradient-to-r from-zinc-900/50 to-zinc-800/50 rounded-2xl p-8 mb-12 border border-zinc-700/50 backdrop-blur-sm">
              ...
              <div className="flex flex-wrap gap-3">
                <span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#ai automation ROI calculator</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#ai automation ROI calculator guide</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#ai automation ROI calculator 2025</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#ai automation ROI calculator course</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#ai automation ROI calculator training</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#ai</span>
              </div>
            </div>
