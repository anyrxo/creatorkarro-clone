...
export const metadata = {
  ...
  keywords: ["ai influencer management","ai influencer management guide","ai influencer management 2025","ai influencer management course","ai influencer management training","ai","ai influencer management","course","training","guide","2025"],
  ...
  openGraph: {
    title: "Ai Influencer Management: Expert Guide 2025",
    description: "ai influencer management guide, ai influencer management tutorial, ai influencer management course - Expert training from the creators of AI Influencers Academy",
    url: "https://iimagined.ai/blog/ai-influencer-management",
    siteName: "IImagined.ai",
    type: "article",
    publishedTime: "2025-08-05T10:00:00.000Z",
    modifiedTime: "2025-08-05T08:27:05.638Z",
    authors: ["IImagined.ai Expert Team"],
    tags: ["ai influencer management","ai influencer management guide","ai influencer management 2025","ai influencer management course","ai influencer management training","ai"],
    images: [{
      url: "https://iimagined.ai/images/ai-influencer-management-og.jpg",
      width: 1200,
      height: 630,
      alt: "Ai Influencer Management: Expert Guide 2025",
      type: "image/jpeg"
    }],
    locale: "en_US"
  },
  ...
  alternates: {
    canonical: "https://iimagined.ai/blog/ai-influencer-management"
  }
}
          ...
          <div className="prose prose-invert prose-lg max-w-none">
            ...
            <div className="bg-gradient-to-r from-zinc-900/50 to-zinc-800/50 rounded-2xl p-8 mb-12 border border-zinc-700/50 backdrop-blur-sm">
              ...
              <div className="flex flex-wrap gap-3">
                <span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#ai influencer management</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#ai influencer management guide</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#ai influencer management 2025</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#ai influencer management course</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#ai influencer management training</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#ai</span>
              </div>
            </div>
