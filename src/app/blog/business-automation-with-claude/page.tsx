...
export const metadata = {
  ...
  keywords: ["business automation with claude","business automation with claude guide","business automation with claude 2025","business automation with claude course","business automation with claude training","business","business automation with claude","course","training","guide","2025"],
  ...
  openGraph: {
    title: "Business Automation With Claude: Expert Guide 2025",
    description: "business automation with claude guide, business automation with claude tutorial, business automation with claude course - Expert training from the creators of A",
    url: "https://iimagined.ai/blog/business-automation-with-claude",
    siteName: "IImagined.ai",
    type: "article",
    publishedTime: "2025-08-05T10:00:00.000Z",
    modifiedTime: "2025-08-05T08:27:05.618Z",
    authors: ["IImagined.ai Expert Team"],
    tags: ["business automation with claude","business automation with claude guide","business automation with claude 2025","business automation with claude course","business automation with claude training","business"],
    images: [{
      url: "https://iimagined.ai/images/business-automation-with-claude-og.jpg",
      width: 1200,
      height: 630,
      alt: "Business Automation With Claude: Expert Guide 2025",
      type: "image/jpeg"
    }],
    locale: "en_US"
  },
  ...
  alternates: {
    canonical: "https://iimagined.ai/blog/business-automation-with-claude"
  }
}
          ...
          <div className="prose prose-invert prose-lg max-w-none">
            ...
            <div className="bg-gradient-to-r from-zinc-900/50 to-zinc-800/50 rounded-2xl p-8 mb-12 border border-zinc-700/50 backdrop-blur-sm">
              ...
              <div className="flex flex-wrap gap-3">
                <span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#business automation with claude</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#business automation with claude guide</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#business automation with claude 2025</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#business automation with claude course</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#business automation with claude training</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#business</span>
              </div>
            </div>
