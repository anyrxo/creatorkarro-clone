...
export const metadata = {
  ...
  keywords: ["comfyui automation consulting","comfyui automation consulting guide","comfyui automation consulting 2025","comfyui automation consulting course","comfyui automation consulting training","comfyui","comfyui automation consulting","course","training","guide","2025"],
  ...
  openGraph: {
    title: "Comfyui Automation Consulting: Expert Guide 2025",
    description: "comfyui automation consulting guide, comfyui automation consulting tutorial, comfyui automation consulting course - Expert training from the creators of ComfyUI",
    url: "https://iimagined.ai/blog/comfyui-automation-consulting",
    siteName: "IImagined.ai",
    type: "article",
    publishedTime: "2025-08-05T10:00:00.000Z",
    modifiedTime: "2025-08-05T08:27:05.637Z",
    authors: ["IImagined.ai Expert Team"],
    tags: ["comfyui automation consulting","comfyui automation consulting guide","comfyui automation consulting 2025","comfyui automation consulting course","comfyui automation consulting training","comfyui"],
    images: [{
      url: "https://iimagined.ai/images/comfyui-automation-consulting-og.jpg",
      width: 1200,
      height: 630,
      alt: "Comfyui Automation Consulting: Expert Guide 2025",
      type: "image/jpeg"
    }],
    locale: "en_US"
  },
  ...
  alternates: {
    canonical: "https://iimagined.ai/blog/comfyui-automation-consulting"
  }
}
          ...
          <div className="prose prose-invert prose-lg max-w-none">
            ...
            <div className="bg-gradient-to-r from-zinc-900/50 to-zinc-800/50 rounded-2xl p-8 mb-12 border border-zinc-700/50 backdrop-blur-sm">
              ...
              <div className="flex flex-wrap gap-3">
                <span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#comfyui automation consulting</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#comfyui automation consulting guide</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#comfyui automation consulting 2025</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#comfyui automation consulting course</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#comfyui automation consulting training</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#comfyui</span>
              </div>
            </div>
