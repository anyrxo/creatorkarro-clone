...
export const metadata = {
  ...
  keywords: ["comfyui business automation","comfyui business automation guide","comfyui business automation 2025","comfyui business automation course","comfyui business automation training","comfyui","comfyui business automation","course","training","guide","2025"],
  ...
  openGraph: {
    title: "Comfyui Business Automation: Expert Guide 2025",
    description: "comfyui business automation guide, comfyui business automation tutorial, comfyui business automation course - Expert training from the creators of ComfyUI Pro T",
    url: "https://iimagined.ai/blog/comfyui-business-automation",
    siteName: "IImagined.ai",
    type: "article",
    publishedTime: "2025-08-05T10:00:00.000Z",
    modifiedTime: "2025-08-05T08:27:05.635Z",
    authors: ["IImagined.ai Expert Team"],
    tags: ["comfyui business automation","comfyui business automation guide","comfyui business automation 2025","comfyui business automation course","comfyui business automation training","comfyui"],
    images: [{
      url: "https://iimagined.ai/images/comfyui-business-automation-og.jpg",
      width: 1200,
      height: 630,
      alt: "Comfyui Business Automation: Expert Guide 2025",
      type: "image/jpeg"
    }],
    locale: "en_US"
  },
  ...
  alternates: {
    canonical: "https://iimagined.ai/blog/comfyui-business-automation"
  }
}
          ...
          <div className="prose prose-invert prose-lg max-w-none">
            ...
            <div className="bg-gradient-to-r from-zinc-900/50 to-zinc-800/50 rounded-2xl p-8 mb-12 border border-zinc-700/50 backdrop-blur-sm">
              ...
              <div className="flex flex-wrap gap-3">
                <span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#comfyui business automation</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#comfyui business automation guide</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#comfyui business automation 2025</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#comfyui business automation course</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#comfyui business automation training</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#comfyui</span>
              </div>
            </div>
