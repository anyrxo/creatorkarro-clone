...
export const metadata = {
  ...
  keywords: ["cloud", "automation", "infrastructure", "cloud 2025", "cloud automation infrastructure", "AI tools", "business growth", "productivity", "2025 strategies"],
  ...
  openGraph: {
    ...
    tags: ["cloud", "automation", "infrastructure", "cloud 2025", "cloud automation infrastructure", "AI tools", "business growth", "productivity"],
    images: [{
      url: "https://iimagined.ai/images/cloud-automation-infrastructure-og.jpg",
      width: 1200,
      height: 630,
      alt: "Cloud Automation Infrastructure",
      type: "image/jpeg"
    }],
    locale: "en_US"
  },
