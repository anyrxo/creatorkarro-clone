...
export const metadata = {
  ...
  keywords: ["deepseek", "janus", "pro", "multimodal", "revolution", "deepseek 2025", "deepseek janus pro multimodal revolution", "automation", "AI tools", "business growth", "productivity", "2025 strategies"],
  ...
  openGraph: {
    ...
    tags: ["deepseek", "janus", "pro", "multimodal", "revolution", "deepseek 2025", "deepseek janus pro multimodal revolution", "automation"],
    images: [{
