...
export const metadata = {
  ...
  keywords: ["comfyui automation systems","comfyui automation systems guide","comfyui automation systems 2025","comfyui automation systems course","comfyui automation systems training","comfyui","comfyui automation systems","course","training","guide","2025"],
  ...
  openGraph: {
    title: "Comfyui Automation Systems: Expert Guide 2025",
    description: "comfyui automation systems guide, comfyui automation systems tutorial, comfyui automation systems course - Expert training from the creators of ComfyUI Pro Trai",
    url: "https://iimagined.ai/blog/comfyui-automation-systems",
    siteName: "IImagined.ai",
    type: "article",
    publishedTime: "2025-08-05T10:00:00.000Z",
    modifiedTime: "2025-08-05T08:27:05.634Z",
    authors: ["IImagined.ai Expert Team"],
    tags: ["comfyui automation systems","comfyui automation systems guide","comfyui automation systems 2025","comfyui automation systems course","comfyui automation systems training","comfyui"],
    images: [{
      url: "https://iimagined.ai/images/comfyui-automation-systems-og.jpg",
      width: 1200,
      height: 630,
      alt: "Comfyui Automation Systems: Expert Guide 2025",
      type: "image/jpeg"
    }],
    locale: "en_US"
  },
  ...
  alternates: {
    canonical: "https://iimagined.ai/blog/comfyui-automation-systems"
  }
}
          ...
          <div className="prose prose-invert prose-lg max-w-none">
            ...
            <div className="bg-gradient-to-r from-zinc-900/50 to-zinc-800/50 rounded-2xl p-8 mb-12 border border-zinc-700/50 backdrop-blur-sm">
              ...
              <div className="flex flex-wrap gap-3">
                <span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#comfyui automation systems</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#comfyui automation systems guide</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#comfyui automation systems 2025</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#comfyui automation systems course</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#comfyui automation systems training</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#comfyui</span>
              </div>
            </div>
