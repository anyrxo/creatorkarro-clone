...
export const metadata = {
  ...
  openGraph: {
    ...
    images: [{
      ...
      width: 1200,
      height: 630,
      alt: "Composer Agent: Full-Stack Development with AI",
      type: "image/jpeg"
    }],
    locale: "en_US"
  },
...
export default function ComposerAgentCodeLlmFullStack() {
    ...
    "@graph": [
      {
        ...
        "mainEntityOfPage": {
          "@type": "WebPage",
          "@id": "https://iimagined.ai/blog/composer-agent-code-llm-full-stack"
        },
        "image": {
          "@type": "ImageObject",
          "url": "https://iimagined.ai/images/composer-agent-code-llm-full-stack-og.jpg",
      ...
      {
        "@type": "BreadcrumbList",
        "@id": "https://iimagined.ai/blog/composer-agent-code-llm-full-stack#breadcrumbs",
        "itemListElement": [
          {
            "@type": "ListItem",
            "position": 1,
          ...
          },
          {
            "@type": "ListItem",
            "position": 3,
            "name": "Composer Agent: Full-Stack Development with AI",
            "item": "https://iimagined.ai/blog/composer-agent-code-llm-full-stack"
          }
        ]
      },
      {
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <nav className="flex mb-8 text-sm" aria-label="Breadcrumb">
                <ol className="inline-flex items-center space-x-1 md:space-x-3">
                  ...
                  <li aria-current="page">
                    <div className="flex items-center">
                      <span className="mx-2 text-gray-500">/</span>
                      <span className="text-gray-300">Composer Agent: Full-Stack Development with AI</span>
                    </div>
                  </li>
                </ol>
              </nav>
              ...
              <header className="mb-12">
                ...
                <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6 leading-tight">
                  Composer Agent: Full-Stack Development with AI
                </h1>
                
                <p className="text-xl text-gray-300 mb-8 leading-relaxed">
                  Complete guide to using Composer Agent for full-stack development with LLMs and advanced coding automation
                </p>
