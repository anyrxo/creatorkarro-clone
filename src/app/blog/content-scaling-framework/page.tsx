...
export default function ContentScalingFramework() {
  ...
  const systemsAnimation = useScrollAnimation({ threshold: 0.1 })
  ...
  return (
    <div className="min-h-screen bg-dark">
      ...
      {/* Scale Phase */}
      <section 
        ref={systemsAnimation.elementRef}
        className={`section-spacing scroll-fade-up ${systemsAnimation.isVisible ? 'visible' : ''}`}
      >
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-5xl">
      ...
      >
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Get the complete C.A.S.H. Framework with templates, SOPs, and coaching
          </p>
          
          <Link
            href="/content-scaling-system"
            className="cta-button inline-flex items-center gap-3"
          >
            Get The Scaling Framework
