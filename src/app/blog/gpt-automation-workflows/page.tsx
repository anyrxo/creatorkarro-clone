...
export const metadata = {
  ...
  keywords: ["gpt automation workflows","gpt automation workflows guide","gpt automation workflows 2025","gpt automation workflows course","gpt automation workflows training","gpt","gpt automation workflows","course","training","guide","2025"],
  ...
  openGraph: {
    title: "Gpt Automation Workflows: Expert Guide 2025",
    description: "gpt automation workflows guide, gpt automation workflows tutorial, gpt automation workflows course - Expert training from the creators of N8N Automation Hub wit",
    url: "https://iimagined.ai/blog/gpt-automation-workflows",
    siteName: "IImagined.ai",
    type: "article",
    publishedTime: "2025-08-05T10:00:00.000Z",
    modifiedTime: "2025-08-05T08:27:05.619Z",
    authors: ["IImagined.ai Expert Team"],
    tags: ["gpt automation workflows","gpt automation workflows guide","gpt automation workflows 2025","gpt automation workflows course","gpt automation workflows training","gpt"],
    images: [{
      url: "https://iimagined.ai/images/gpt-automation-workflows-og.jpg",
      width: 1200,
      height: 630,
      alt: "Gpt Automation Workflows: Expert Guide 2025",
      type: "image/jpeg"
    }],
    locale: "en_US"
  },
  ...
  alternates: {
    canonical: "https://iimagined.ai/blog/gpt-automation-workflows"
  }
}
          ...
          <div className="prose prose-invert prose-lg max-w-none">
            ...
            <div className="bg-gradient-to-r from-zinc-900/50 to-zinc-800/50 rounded-2xl p-8 mb-12 border border-zinc-700/50 backdrop-blur-sm">
              ...
              <div className="flex flex-wrap gap-3">
                <span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#gpt automation workflows</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#gpt automation workflows guide</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#gpt automation workflows 2025</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#gpt automation workflows course</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#gpt automation workflows training</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#gpt</span>
              </div>
            </div>
