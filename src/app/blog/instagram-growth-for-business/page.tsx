...
export const metadata = {
  ...
  keywords: ["instagram growth for business","instagram growth for business guide","instagram growth for business 2025","instagram growth for business course","instagram growth for business training","instagram","instagram growth for business","course","training","guide","2025"],
  ...
  openGraph: {
    title: "Instagram Growth For Business: Expert Guide 2025",
    description: "instagram growth for business guide, instagram growth for business tutorial, instagram growth for business course - Expert training from the creators of Instagr",
    url: "https://iimagined.ai/blog/instagram-growth-for-business",
    siteName: "IImagined.ai",
    type: "article",
    publishedTime: "2025-08-05T10:00:00.000Z",
    modifiedTime: "2025-08-05T08:27:05.624Z",
    authors: ["IImagined.ai Expert Team"],
    tags: ["instagram growth for business","instagram growth for business guide","instagram growth for business 2025","instagram growth for business course","instagram growth for business training","instagram"],
    images: [{
      url: "https://iimagined.ai/images/instagram-growth-for-business-og.jpg",
      width: 1200,
      height: 630,
      alt: "Instagram Growth For Business: Expert Guide 2025",
      type: "image/jpeg"
    }],
    locale: "en_US"
  },
  ...
  alternates: {
    canonical: "https://iimagined.ai/blog/instagram-growth-for-business"
  }
}
          ...
          <div className="prose prose-invert prose-lg max-w-none">
            ...
            <div className="bg-gradient-to-r from-zinc-900/50 to-zinc-800/50 rounded-2xl p-8 mb-12 border border-zinc-700/50 backdrop-blur-sm">
              ...
              <div className="flex flex-wrap gap-3">
                <span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#instagram growth for business</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#instagram growth for business guide</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#instagram growth for business 2025</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#instagram growth for business course</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#instagram growth for business training</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#instagram</span>
              </div>
            </div>
