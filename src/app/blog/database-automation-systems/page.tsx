...
export const metadata = {
  ...
  openGraph: {
    ...
    tags: ["database", "automation", "systems", "database 2025", "database automation systems", "AI tools", "business growth", "productivity"],
    images: [{
      ...
      >
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Join our AI Agents Course and master database automation systems
          </p>
          ...
          >
            Start Database Automation Mastery
