...
export const metadata = {
  ...
  keywords: ["comfyui api integration","comfyui api integration guide","comfyui api integration 2025","comfyui api integration course","comfyui api integration training","comfyui","comfyui api integration","course","training","guide","2025"],
  ...
  openGraph: {
    title: "Comfyui Api Integration: Expert Guide 2025",
    description: "comfyui api integration guide, comfyui api integration tutorial, comfyui api integration course - Expert training from the creators of ComfyUI Pro Training with",
    url: "https://iimagined.ai/blog/comfyui-api-integration",
    siteName: "IImagined.ai",
    type: "article",
    publishedTime: "2025-08-05T10:00:00.000Z",
    modifiedTime: "2025-08-05T08:27:05.633Z",
    authors: ["IImagined.ai Expert Team"],
    tags: ["comfyui api integration","comfyui api integration guide","comfyui api integration 2025","comfyui api integration course","comfyui api integration training","comfyui"],
    images: [{
      url: "https://iimagined.ai/images/comfyui-api-integration-og.jpg",
      width: 1200,
      height: 630,
      alt: "Comfyui Api Integration: Expert Guide 2025",
      type: "image/jpeg"
    }],
    locale: "en_US"
  },
  ...
  alternates: {
    canonical: "https://iimagined.ai/blog/comfyui-api-integration"
  }
}
          ...
          <div className="prose prose-invert prose-lg max-w-none">
            ...
            <div className="bg-gradient-to-r from-zinc-900/50 to-zinc-800/50 rounded-2xl p-8 mb-12 border border-zinc-700/50 backdrop-blur-sm">
              ...
              <div className="flex flex-wrap gap-3">
                <span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#comfyui api integration</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#comfyui api integration guide</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#comfyui api integration 2025</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#comfyui api integration course</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#comfyui api integration training</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#comfyui</span>
              </div>
            </div>
