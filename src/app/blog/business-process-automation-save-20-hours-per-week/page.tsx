...
// Build dashboards with this data in Grafana, Metabase, etc.`}
                ...
                <div className="bg-gradient-to-r from-blue-600/20 to-purple-600/20 border border-blue-500/30 rounded-2xl p-8 mb-8">
                  <div className="text-center">
                    <h3 className="text-2xl font-bold text-white mb-4">Ready to Build Your Automation Strategy?</h3>
                    <p className="text-lg text-gray-300 mb-6">
                      Our comprehensive N8N course includes ready-to-deploy automation templates, video tutorials,
                      and a complete automation implementation framework for your business.
                    </p>
