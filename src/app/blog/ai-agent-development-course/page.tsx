...
export const metadata = {
  ...
  keywords: ["ai agent development course","ai agent development course guide","ai agent development course 2025","ai agent development course course","ai agent development course training","ai","ai agent development course","course","training","guide","2025"],
  ...
  openGraph: {
    title: "Ai Agent Development Course: Expert Guide 2025",
    description: "ai agent development course guide, ai agent development course tutorial, ai agent development course course - Expert training from the creators of AI Automation",
    url: "https://iimagined.ai/blog/ai-agent-development-course",
    siteName: "IImagined.ai",
    type: "article",
    publishedTime: "2025-08-05T10:00:00.000Z",
    modifiedTime: "2025-08-05T08:27:05.618Z",
    authors: ["IImagined.ai Expert Team"],
    tags: ["ai agent development course","ai agent development course guide","ai agent development course 2025","ai agent development course course","ai agent development course training","ai"],
    images: [{
      url: "https://iimagined.ai/images/ai-agent-development-course-og.jpg",
      width: 1200,
      height: 630,
      alt: "Ai Agent Development Course: Expert Guide 2025",
      type: "image/jpeg"
    }],
    locale: "en_US"
  },
  ...
  alternates: {
    canonical: "https://iimagined.ai/blog/ai-agent-development-course"
  }
}
          ...
          <div className="prose prose-invert prose-lg max-w-none">
            ...
            <div className="bg-gradient-to-r from-zinc-900/50 to-zinc-800/50 rounded-2xl p-8 mb-12 border border-zinc-700/50 backdrop-blur-sm">
              ...
              <div className="flex flex-wrap gap-3">
                <span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#ai agent development course</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#ai agent development course guide</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#ai agent development course 2025</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#ai agent development course course</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#ai agent development course training</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#ai</span>
              </div>
            </div>
