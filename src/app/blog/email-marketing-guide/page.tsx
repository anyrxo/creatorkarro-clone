  ...
  return (
    ...
    <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <h2 className="text-3xl md:text-4xl font-bold mb-6">
            Ready to Build Your $10K/Month Email System?
        </h2>

        <p className="text-xl text-gray-400 mb-8">
            Get the complete email marketing blueprint with templates, sequences, and AI-powered strategies
        </p>
        ...
        <Link
          ...
          >
            Get The Email Marketing System
