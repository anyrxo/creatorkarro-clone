...
export const metadata = {
  ...
  keywords: ["instagram growth automation","instagram growth automation guide","instagram growth automation 2025","instagram growth automation course","instagram growth automation training","instagram","instagram growth automation","course","training","guide","2025"],
  ...
  openGraph: {
    title: "Instagram Growth Automation: Expert Guide 2025",
    description: "instagram growth automation guide, instagram growth automation tutorial, instagram growth automation course - Expert training from the creators of Instagram Gro",
    url: "https://iimagined.ai/blog/instagram-growth-automation",
    siteName: "IImagined.ai",
    type: "article",
    publishedTime: "2025-08-05T10:00:00.000Z",
    modifiedTime: "2025-08-05T08:27:05.626Z",
    authors: ["IImagined.ai Expert Team"],
    tags: ["instagram growth automation","instagram growth automation guide","instagram growth automation 2025","instagram growth automation course","instagram growth automation training","instagram"],
    images: [{
      url: "https://iimagined.ai/images/instagram-growth-automation-og.jpg",
      width: 1200,
      height: 630,
      alt: "Instagram Growth Automation: Expert Guide 2025",
      type: "image/jpeg"
    }],
    locale: "en_US"
  },
  ...
  alternates: {
    canonical: "https://iimagined.ai/blog/instagram-growth-automation"
  }
}
          ...
          <div className="prose prose-invert prose-lg max-w-none">
            ...
            <div className="bg-gradient-to-r from-zinc-900/50 to-zinc-800/50 rounded-2xl p-8 mb-12 border border-zinc-700/50 backdrop-blur-sm">
              ...
              <div className="flex flex-wrap gap-3">
                <span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#instagram growth automation</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#instagram growth automation guide</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#instagram growth automation 2025</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#instagram growth automation course</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#instagram growth automation training</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#instagram</span>
              </div>
            </div>
