...
export const metadata: Metadata = {
  ...
  description: 'LLaMA 4 revolutionizes open-source AI with 10 million token context, IRO architecture, and three specialized models (Scoot, Maverick, Behemoth). Discover how Meta\'s latest model democratizes enterprise-grade AI.',
  keywords: 'LLaMA 4, Meta AI, open source AI, 10 million tokens, IRO architecture, Mixture of Experts, local AI deployment, GPT-4 alternative',
  openGraph: {
    title: 'LLaMA 4: 10 Million Token Open-Source AI Powerhouse',
    description: 'Meta\'s groundbreaking open-source model with unprecedented context length and multimodal capabilities',
    type: 'article',
    publishedTime: '2025-01-01T10:00:00.000Z',
    authors: ['Anyro'],
    tags: ['AI', 'Open Source', 'LLaMA', 'Meta', 'Machine Learning']
}
}
