...
export const metadata = {
  ...
  keywords: ["instagram business strategy","instagram business strategy guide","instagram business strategy 2025","instagram business strategy course","instagram business strategy training","instagram","instagram business strategy","course","training","guide","2025"],
  ...
  openGraph: {
    title: "Instagram Business Strategy: Expert Guide 2025",
    description: "instagram business strategy guide, instagram business strategy tutorial, instagram business strategy course - Expert training from the creators of Instagram Gro",
    url: "https://iimagined.ai/blog/instagram-business-strategy",
    siteName: "IImagined.ai",
    type: "article",
    publishedTime: "2025-08-05T10:00:00.000Z",
    modifiedTime: "2025-08-05T08:27:05.627Z",
    authors: ["IImagined.ai Expert Team"],
    tags: ["instagram business strategy","instagram business strategy guide","instagram business strategy 2025","instagram business strategy course","instagram business strategy training","instagram"],
    images: [{
      url: "https://iimagined.ai/images/instagram-business-strategy-og.jpg",
      width: 1200,
      height: 630,
      alt: "Instagram Business Strategy: Expert Guide 2025",
      type: "image/jpeg"
    }],
    locale: "en_US"
  },
  ...
  alternates: {
    canonical: "https://iimagined.ai/blog/instagram-business-strategy"
  }
}
          ...
          <div className="prose prose-invert prose-lg max-w-none">
            ...
            <div className="bg-gradient-to-r from-zinc-900/50 to-zinc-800/50 rounded-2xl p-8 mb-12 border border-zinc-700/50 backdrop-blur-sm">
              ...
              <div className="flex flex-wrap gap-3">
                <span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#instagram business strategy</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#instagram business strategy guide</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#instagram business strategy 2025</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#instagram business strategy course</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#instagram business strategy training</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#instagram</span>
              </div>
            </div>
