...
export const metadata = {
  ...
  keywords: ["automation agency pricing","automation agency pricing guide","automation agency pricing 2025","automation agency pricing course","automation agency pricing training","automation","automation agency pricing","course","training","guide","2025"],
  ...
  openGraph: {
    title: "Automation Agency Pricing: Expert Guide 2025",
    description: "automation agency pricing guide, automation agency pricing tutorial, automation agency pricing course - Expert training from the creators of AI Automation Maste",
    url: "https://iimagined.ai/blog/automation-agency-pricing",
    siteName: "IImagined.ai",
    type: "article",
    publishedTime: "2025-08-05T10:00:00.000Z",
    modifiedTime: "2025-08-05T08:27:05.622Z",
    authors: ["IImagined.ai Expert Team"],
    tags: ["automation agency pricing","automation agency pricing guide","automation agency pricing 2025","automation agency pricing course","automation agency pricing training","automation"],
    images: [{
      url: "https://iimagined.ai/images/automation-agency-pricing-og.jpg",
      width: 1200,
      height: 630,
      alt: "Automation Agency Pricing: Expert Guide 2025",
      type: "image/jpeg"
    }],
    locale: "en_US"
  },
  ...
  alternates: {
    canonical: "https://iimagined.ai/blog/automation-agency-pricing"
  }
}
          ...
          <div className="prose prose-invert prose-lg max-w-none">
            ...
            <div className="bg-gradient-to-r from-zinc-900/50 to-zinc-800/50 rounded-2xl p-8 mb-12 border border-zinc-700/50 backdrop-blur-sm">
              ...
              <div className="flex flex-wrap gap-3">
                <span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#automation agency pricing</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#automation agency pricing guide</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#automation agency pricing 2025</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#automation agency pricing course</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#automation agency pricing training</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#automation</span>
              </div>
            </div>
