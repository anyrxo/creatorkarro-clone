...
export const metadata: Metadata = {
  ...
  description: 'Anthropic Claude 4 marks a strategic pivot from chatbots to agentic coding infrastructure. Discover how Claude 4 Opus and Sonnet are revolutionizing enterprise automation and development workflows.',
  keywords: 'Claude 4, agentic AI, coding automation, AI development tools, Anthropic, software development AI, enterprise automation, AI coding assistant',
  openGraph: {
    title: 'Claude 4: The Agentic AI Revolution in Software Development',
    description: 'How Anthropic\'s Claude 4 is transforming from chatbot to enterprise coding powerhouse',
    type: 'article',
    publishedTime: '2025-01-01T10:00:00.000Z',
    authors: ['Anyro'],
    tags: ['AI', 'Software Development', 'Automation', 'Claude 4', 'Anthropic']
}
}
