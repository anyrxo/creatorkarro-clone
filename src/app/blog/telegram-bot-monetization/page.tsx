...
export const metadata = {
  ...
  openGraph: {
    ...
    modifiedTime: "2026-08-03T06:14:29.958Z",
    authors: ["Anyro"],
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    <ul className="text-gray-300 space-y-2 text-sm">
                      ...
                      <li>• FOMO-triggered Access sequences</li>
                ...
                <div className="bg-gradient-to-br from-teal-800 to-cyan-800 border border-teal-600 rounded-lg p-6">
                  ...
                  <div className="bg-teal-900 bg-opacity-50 rounded-lg p-4 mb-4">
                    ...
                    <ul className="text-white space-y-1 text-sm">
                      ...
                      <li>• $197 average course Access</li>
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <ul className="text-gray-300 space-y-1 text-sm">
                      <li>• Multiple revenue streams (subscriptions + one-time Accesss)</li>
