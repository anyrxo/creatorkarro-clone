...
export const metadata = {
  ...
  keywords: ["comfyui business case studies","comfyui business case studies guide","comfyui business case studies 2025","comfyui business case studies course","comfyui business case studies training","comfyui","comfyui business case studies","course","training","guide","2025"],
  ...
  openGraph: {
    title: "Comfyui Business Case Studies: Expert Guide 2025",
    description: "comfyui business case studies guide, comfyui business case studies tutorial, comfyui business case studies course - Expert training from the creators of ComfyUI",
    url: "https://iimagined.ai/blog/comfyui-business-case-studies",
    siteName: "IImagined.ai",
    type: "article",
    publishedTime: "2025-08-05T10:00:00.000Z",
    modifiedTime: "2025-08-05T08:27:05.636Z",
    authors: ["IImagined.ai Expert Team"],
    tags: ["comfyui business case studies","comfyui business case studies guide","comfyui business case studies 2025","comfyui business case studies course","comfyui business case studies training","comfyui"],
    images: [{
      url: "https://iimagined.ai/images/comfyui-business-case-studies-og.jpg",
      width: 1200,
      height: 630,
      alt: "Comfyui Business Case Studies: Expert Guide 2025",
      type: "image/jpeg"
    }],
    locale: "en_US"
  },
  ...
  alternates: {
    canonical: "https://iimagined.ai/blog/comfyui-business-case-studies"
  }
}
          ...
          <div className="prose prose-invert prose-lg max-w-none">
            ...
            <div className="bg-gradient-to-r from-zinc-900/50 to-zinc-800/50 rounded-2xl p-8 mb-12 border border-zinc-700/50 backdrop-blur-sm">
              ...
              <div className="flex flex-wrap gap-3">
                <span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#comfyui business case studies</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#comfyui business case studies guide</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#comfyui business case studies 2025</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#comfyui business case studies course</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#comfyui business case studies training</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#comfyui</span>
              </div>
            </div>
