...
export const metadata = {
  ...
  keywords: ["business automation blueprint","business automation blueprint guide","business automation blueprint 2025","business automation blueprint course","business automation blueprint training","business","business automation blueprint","course","training","guide","2025"],
  ...
  openGraph: {
    title: "Business Automation Blueprint: Expert Guide 2025",
    description: "business automation blueprint guide, business automation blueprint tutorial, business automation blueprint course - Expert training from the creators of AI Auto",
    url: "https://iimagined.ai/blog/business-automation-blueprint",
    siteName: "IImagined.ai",
    type: "article",
    publishedTime: "2025-08-05T10:00:00.000Z",
    modifiedTime: "2025-08-05T08:27:05.621Z",
    authors: ["IImagined.ai Expert Team"],
    tags: ["business automation blueprint","business automation blueprint guide","business automation blueprint 2025","business automation blueprint course","business automation blueprint training","business"],
    images: [{
      url: "https://iimagined.ai/images/business-automation-blueprint-og.jpg",
      width: 1200,
      height: 630,
      alt: "Business Automation Blueprint: Expert Guide 2025",
      type: "image/jpeg"
    }],
    locale: "en_US"
  },
  ...
  alternates: {
    canonical: "https://iimagined.ai/blog/business-automation-blueprint"
  }
}
          ...
          <div className="prose prose-invert prose-lg max-w-none">
            ...
            <div className="bg-gradient-to-r from-zinc-900/50 to-zinc-800/50 rounded-2xl p-8 mb-12 border border-zinc-700/50 backdrop-blur-sm">
              ...
              <div className="flex flex-wrap gap-3">
                <span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#business automation blueprint</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#business automation blueprint guide</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#business automation blueprint 2025</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#business automation blueprint course</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#business automation blueprint training</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#business</span>
              </div>
            </div>
