...
export const metadata = {
  ...
  description: "ai content creation, ai social media content, virtual influencer content - Expert guide from the creators of AI Influencers Academy with 127K+ students and $2.7M+ in student revenue",
