...
export const metadata = {
  ...
  keywords: ["comfyui batch processing","comfyui batch processing guide","comfyui batch processing 2025","comfyui batch processing course","comfyui batch processing training","comfyui","comfyui batch processing","course","training","guide","2025"],
  ...
  openGraph: {
    title: "Comfyui Batch Processing: Expert Guide 2025",
    description: "comfyui batch processing guide, comfyui batch processing tutorial, comfyui batch processing course - Expert training from the creators of ComfyUI Pro Training w",
    url: "https://iimagined.ai/blog/comfyui-batch-processing",
    siteName: "IImagined.ai",
    type: "article",
    publishedTime: "2025-08-05T10:00:00.000Z",
    modifiedTime: "2025-08-05T08:27:05.633Z",
    authors: ["IImagined.ai Expert Team"],
    tags: ["comfyui batch processing","comfyui batch processing guide","comfyui batch processing 2025","comfyui batch processing course","comfyui batch processing training","comfyui"],
    images: [{
      url: "https://iimagined.ai/images/comfyui-batch-processing-og.jpg",
      width: 1200,
      height: 630,
      alt: "Comfyui Batch Processing: Expert Guide 2025",
      type: "image/jpeg"
    }],
    locale: "en_US"
  },
  ...
  alternates: {
    canonical: "https://iimagined.ai/blog/comfyui-batch-processing"
  }
}
          ...
          <div className="prose prose-invert prose-lg max-w-none">
            ...
            <div className="bg-gradient-to-r from-zinc-900/50 to-zinc-800/50 rounded-2xl p-8 mb-12 border border-zinc-700/50 backdrop-blur-sm">
              ...
              <div className="flex flex-wrap gap-3">
                <span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#comfyui batch processing</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#comfyui batch processing guide</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#comfyui batch processing 2025</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#comfyui batch processing course</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#comfyui batch processing training</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#comfyui</span>
              </div>
            </div>
