...
export const metadata = {
  ...
  keywords: ["automation project management","automation project management guide","automation project management 2025","automation project management course","automation project management training","automation","automation project management","course","training","guide","2025"],
  ...
  openGraph: {
    title: "Automation Project Management: Expert Guide 2025",
    description: "automation project management guide, automation project management tutorial, automation project management course - Expert training from the creators of AI Auto",
    url: "https://iimagined.ai/blog/automation-project-management",
    siteName: "IImagined.ai",
    type: "article",
    publishedTime: "2025-08-05T10:00:00.000Z",
    modifiedTime: "2025-08-05T08:27:05.622Z",
    authors: ["IImagined.ai Expert Team"],
    tags: ["automation project management","automation project management guide","automation project management 2025","automation project management course","automation project management training","automation"],
    images: [{
      url: "https://iimagined.ai/images/automation-project-management-og.jpg",
      width: 1200,
      height: 630,
      alt: "Automation Project Management: Expert Guide 2025",
      type: "image/jpeg"
    }],
    locale: "en_US"
  },
  ...
  alternates: {
    canonical: "https://iimagined.ai/blog/automation-project-management"
  }
}
          ...
          <div className="prose prose-invert prose-lg max-w-none">
            ...
            <div className="bg-gradient-to-r from-zinc-900/50 to-zinc-800/50 rounded-2xl p-8 mb-12 border border-zinc-700/50 backdrop-blur-sm">
              ...
              <div className="flex flex-wrap gap-3">
                <span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#automation project management</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#automation project management guide</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#automation project management 2025</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#automation project management course</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#automation project management training</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#automation</span>
              </div>
            </div>
