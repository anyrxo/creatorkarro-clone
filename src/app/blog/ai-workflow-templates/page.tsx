...
export const metadata = {
  ...
  keywords: ["ai workflow templates","ai workflow templates guide","ai workflow templates 2025","ai workflow templates course","ai workflow templates training","ai","ai workflow templates","course","training","guide","2025"],
  ...
  openGraph: {
    title: "Ai Workflow Templates: Expert Guide 2025",
    description: "ai workflow templates guide, ai workflow templates tutorial, ai workflow templates course - Expert training from the creators of N8N Automation Hub with 45K+ st",
    url: "https://iimagined.ai/blog/ai-workflow-templates",
    siteName: "IImagined.ai",
    type: "article",
    publishedTime: "2025-08-05T10:00:00.000Z",
    modifiedTime: "2025-08-05T08:27:05.621Z",
    authors: ["IImagined.ai Expert Team"],
    tags: ["ai workflow templates","ai workflow templates guide","ai workflow templates 2025","ai workflow templates course","ai workflow templates training","ai"],
    images: [{
      url: "https://iimagined.ai/images/ai-workflow-templates-og.jpg",
      width: 1200,
      height: 630,
      alt: "Ai Workflow Templates: Expert Guide 2025",
      type: "image/jpeg"
    }],
    locale: "en_US"
  },
  ...
  alternates: {
    canonical: "https://iimagined.ai/blog/ai-workflow-templates"
  }
}
          ...
          <div className="prose prose-invert prose-lg max-w-none">
            ...
            <div className="bg-gradient-to-r from-zinc-900/50 to-zinc-800/50 rounded-2xl p-8 mb-12 border border-zinc-700/50 backdrop-blur-sm">
              ...
              <div className="flex flex-wrap gap-3">
                <span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#ai workflow templates</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#ai workflow templates guide</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#ai workflow templates 2025</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#ai workflow templates course</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#ai workflow templates training</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#ai</span>
              </div>
            </div>
