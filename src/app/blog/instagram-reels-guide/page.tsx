...
export default function InstagramReelsGuide() {
  ...
  const algorithmAnimation = useScrollAnimation({ threshold: 0.1 })
  ...
  return (
    <div className="min-h-screen bg-dark">
      ...
      {/* Algorithm Secrets */}
      <section 
        ref={algorithmAnimation.elementRef}
        className={`section-spacing scroll-fade-up ${algorithmAnimation.isVisible ? 'visible' : ''}`}
      >
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-5xl">
      ...
      <section 
        ...
        className={`section-spacing scroll-fade-up ${monetizationAnimation.isVisible ? 'visible' : ''}`}
      >
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
