...
export const metadata = {
  title: 'Make.com Automation Guide: Save 25+ Hours Weekly & 380% ROI | IImagined.ai',
  description: 'Complete Make.com automation guide with 90-day implementation roadmap, pricing comparison, and real case studies. Save $85K+ annually with proven strategies.',
  keywords: [
    'make.com automation',
    'make automation guide',
    'make.com pricing',
    'make.com vs zapier',
    'make automation tutorial',
    'integromat automation',
    'make.com implementation',
    'make.com case studies',
    'make automation cost',
    'make.com small business',
    'make.com enterprise',
    'visual automation platform',
    'workflow automation make',
    'make.com operations pricing',
    'business automation make',
    'make.com security compliance',
    'automated workflows make',
    'make.com roi calculation',
    'no code automation make',
    'make.com integrations list',
    'make automation best practices',
    'e-commerce automation make',
    'make.com training guide'
  ],
  openGraph: {
    title: 'Make.com Automation Guide: Save 25+ Hours Weekly & 380% ROI',
    description: 'Complete Make.com automation guide with 90-day implementation roadmap, pricing comparison, and real case studies. Save $85K+ annually with proven strategies.',
    type: 'article',
    publishedTime: '2025-08-02T23:37:46.224Z',
    authors: ['IImagined.ai Team'],
    tags: ['make.com automation', 'workflow automation', 'business automation', 'make.com guide', 'automation roi'],
  }
};