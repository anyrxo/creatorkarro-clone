...
export const metadata = {
  ...
  keywords: ["n8n custom nodes","n8n custom nodes guide","n8n custom nodes 2025","n8n custom nodes course","n8n custom nodes training","n8n","n8n custom nodes","course","training","guide","2025"],
  ...
  openGraph: {
    ...
    tags: ["n8n custom nodes","n8n custom nodes guide","n8n custom nodes 2025","n8n custom nodes course","n8n custom nodes training","n8n"],
    images: [{
      url: "https://iimagined.ai/images/n8n-custom-nodes-og.jpg",
      width: 1200,
      height: 630,
      alt: "N8n Custom Nodes: Expert Guide 2025",
      type: "image/jpeg"
    }],
    locale: "en_US"
  },
  ...
  alternates: {
    canonical: "https://iimagined.ai/blog/n8n-custom-nodes"
  }
}
          ...
          <div className="prose prose-invert prose-lg max-w-none">
            ...
            <div className="bg-gradient-to-r from-zinc-900/50 to-zinc-800/50 rounded-2xl p-8 mb-12 border border-zinc-700/50 backdrop-blur-sm">
              ...
              <div className="flex flex-wrap gap-3">
                <span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#n8n custom nodes</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#n8n custom nodes guide</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#n8n custom nodes 2025</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#n8n custom nodes course</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#n8n custom nodes training</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#n8n</span>
              </div>
            </div>
