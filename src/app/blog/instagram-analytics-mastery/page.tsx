...
export const metadata = {
  ...
  keywords: ["instagram analytics mastery","instagram analytics mastery guide","instagram analytics mastery 2025","instagram analytics mastery course","instagram analytics mastery training","instagram","instagram analytics mastery","course","training","guide","2025"],
  ...
  openGraph: {
    title: "Instagram Analytics Mastery: Expert Guide 2025",
    description: "instagram analytics mastery guide, instagram analytics mastery tutorial, instagram analytics mastery course - Expert training from the creators of Instagram Gro",
    url: "https://iimagined.ai/blog/instagram-analytics-mastery",
    siteName: "IImagined.ai",
    type: "article",
    publishedTime: "2025-08-05T10:00:00.000Z",
    modifiedTime: "2025-08-05T08:27:05.626Z",
    authors: ["IImagined.ai Expert Team"],
    tags: ["instagram analytics mastery","instagram analytics mastery guide","instagram analytics mastery 2025","instagram analytics mastery course","instagram analytics mastery training","instagram"],
    images: [{
      url: "https://iimagined.ai/images/instagram-analytics-mastery-og.jpg",
      width: 1200,
      height: 630,
      alt: "Instagram Analytics Mastery: Expert Guide 2025",
      type: "image/jpeg"
    }],
    locale: "en_US"
  },
  ...
  alternates: {
    canonical: "https://iimagined.ai/blog/instagram-analytics-mastery"
  }
}
          ...
          <div className="prose prose-invert prose-lg max-w-none">
            ...
            <div className="bg-gradient-to-r from-zinc-900/50 to-zinc-800/50 rounded-2xl p-8 mb-12 border border-zinc-700/50 backdrop-blur-sm">
              ...
              <div className="flex flex-wrap gap-3">
                <span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#instagram analytics mastery</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#instagram analytics mastery guide</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#instagram analytics mastery 2025</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#instagram analytics mastery course</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#instagram analytics mastery training</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#instagram</span>
              </div>
            </div>
