...
export const metadata = {
  ...
  keywords: ["instagram influence building","instagram influence building guide","instagram influence building 2025","instagram influence building course","instagram influence building training","instagram","instagram influence building","course","training","guide","2025"],
  ...
  openGraph: {
    title: "Instagram Influence Building: Expert Guide 2025",
    description: "instagram influence building guide, instagram influence building tutorial, instagram influence building course - Expert training from the creators of Instagram ",
    url: "https://iimagined.ai/blog/instagram-influence-building",
    siteName: "IImagined.ai",
    type: "article",
    publishedTime: "2025-08-05T10:00:00.000Z",
    modifiedTime: "2025-08-05T08:27:05.624Z",
    authors: ["IImagined.ai Expert Team"],
    tags: ["instagram influence building","instagram influence building guide","instagram influence building 2025","instagram influence building course","instagram influence building training","instagram"],
    images: [{
      url: "https://iimagined.ai/images/instagram-influence-building-og.jpg",
      width: 1200,
      height: 630,
      alt: "Instagram Influence Building: Expert Guide 2025",
      type: "image/jpeg"
    }],
    locale: "en_US"
  },
  ...
  alternates: {
    canonical: "https://iimagined.ai/blog/instagram-influence-building"
  }
}
          ...
          <div className="prose prose-invert prose-lg max-w-none">
            ...
            <div className="bg-gradient-to-r from-zinc-900/50 to-zinc-800/50 rounded-2xl p-8 mb-12 border border-zinc-700/50 backdrop-blur-sm">
              ...
              <div className="flex flex-wrap gap-3">
                <span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#instagram influence building</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#instagram influence building guide</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#instagram influence building 2025</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#instagram influence building course</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#instagram influence building training</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#instagram</span>
              </div>
            </div>
