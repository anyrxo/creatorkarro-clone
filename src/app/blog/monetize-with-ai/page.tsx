                                ...
                                <div className="bg-gradient-to-br from-green-900/30 to-blue-900/30 rounded-lg p-6 border border-green-500/30">
                                    ...
                                    <div className="mb-6">
                                        ...
                                        <div className="space-y-4">
                                            ...
                                            <div>
                                                <div>
                                                    <p className="font-semibold text-white mb-2">Method 2: Direct Outreach via Email (Best for high-ticket clients)</p>
                                                    <div className="mb-3 text-sm text-gray-300">
                                                        <p><strong>Timeline to first client:</strong> 14-30 days</p>
                                                        <p><strong>Cost:</strong> $0-50/month (email finder tools)</p>
                                                        <p><strong>Success rate:</strong> 5-15% response rate, 20-30% conversion</p>
                                                    </div>

                                                    <p className="font-semibold text-white mb-2">Step-by-step process:</p>
                                                    <ol className="list-decimal list-inside space-y-1 ml-2 mb-3 text-gray-300">
                                                        <li>Identify 200 potential clients in your niche</li>
                                                        <li>Find contact info using Hunter.io (free: 50 searches/month)</li>
                                                        <li>Send personalized emails offering free value</li>
                                                        <li>Follow up 3 times if no response</li>
                                                        <li>Book calls with interested prospects</li>
                                                    </ol>

                                                    <p className="font-semibold text-white mb-2">How to build your prospect list:</p>
                                                    <ul className="list-disc list-inside space-y-1 ml-2 mb-3 text-gray-300">
                                                        <li>Use Google: "[your niche] blog" or "[your niche] company"</li>
                                                        <li>Check LinkedIn: Filter by industry and company size</li>
                                                        <li>Browse directories: Clutch, GoodFirms, industry-specific sites</li>
                                                        <li>Social media: Instagram, Twitter, TikTok in your niche</li>
                                                    </ul>

                                                    <div className="bg-zinc-800/50 rounded p-4">
                                                        <p className="font-semibold text-white mb-2">Email sequence that works:</p>
                                                        <p className="text-sm font-semibold text-green-400 mb-2">Email 1: Value-first approach</p>
                                                        <p className="text-sm text-gray-300 mb-2"><strong>Subject:</strong> Free AI content audit for [Company Name]</p>
                                                        <div className="text-sm italic text-gray-300 space-y-2 border-l-2 border-zinc-600 pl-3">
                                                            <p>"Hi [Name],</p>
                                                            <p>I noticed [specific observation about their content/website].</p>
                                                            <p>I specialize in AI-powered content that [specific benefit relevant to them].</p>
                                                            <p>I'd like to offer you a free AI content audit - I'll analyze 3 of your pages and send you specific, actionable improvements.</p>
                                                            <p>No cost, no obligation, no sales pitch.</p>
                                                            <p>Interested? Just reply "yes" and I'll send you the audit within 48 hours.</p>
                                                            <p>Best,<br />[Your Name]"</p>
                                                        </div>
                                                        <p className="text-xs text-green-400 mt-2">Response rate: 10-20%</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div>
