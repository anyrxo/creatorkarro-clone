...
export const metadata = {
  ...
  keywords: ["comfyui professional workflows","comfyui professional workflows guide","comfyui professional workflows 2025","comfyui professional workflows course","comfyui professional workflows training","comfyui","comfyui professional workflows","course","training","guide","2025"],
  ...
  openGraph: {
    title: "Comfyui Professional Workflows: Expert Guide 2025",
    description: "comfyui professional workflows guide, comfyui professional workflows tutorial, comfyui professional workflows course - Expert training from the creators of N8N ",
    url: "https://iimagined.ai/blog/comfyui-professional-workflows",
    siteName: "IImagined.ai",
    type: "article",
    publishedTime: "2025-08-05T10:00:00.000Z",
    modifiedTime: "2025-08-05T08:27:05.636Z",
    authors: ["IImagined.ai Expert Team"],
    tags: ["comfyui professional workflows","comfyui professional workflows guide","comfyui professional workflows 2025","comfyui professional workflows course","comfyui professional workflows training","comfyui"],
    images: [{
      url: "https://iimagined.ai/images/comfyui-professional-workflows-og.jpg",
      width: 1200,
      height: 630,
      alt: "Comfyui Professional Workflows: Expert Guide 2025",
      type: "image/jpeg"
    }],
    locale: "en_US"
  },
  ...
  alternates: {
    canonical: "https://iimagined.ai/blog/comfyui-professional-workflows"
  }
}
          ...
          <div className="prose prose-invert prose-lg max-w-none">
            ...
            <div className="bg-gradient-to-r from-zinc-900/50 to-zinc-800/50 rounded-2xl p-8 mb-12 border border-zinc-700/50 backdrop-blur-sm">
              ...
              <div className="flex flex-wrap gap-3">
                <span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#comfyui professional workflows</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#comfyui professional workflows guide</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#comfyui professional workflows 2025</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#comfyui professional workflows course</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#comfyui professional workflows training</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#comfyui</span>
              </div>
            </div>
