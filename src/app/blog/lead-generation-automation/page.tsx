...
export const metadata = {
  title: 'Lead Generation Automation: Complete Automation Guide 2025 | IImagined.ai',
  description: 'Master lead generation automation with our comprehensive guide. Learn advanced automation strategies, tools, and techniques. lead generation automation, lead generation automation guide, lead generation automation tutorial.',
  keywords: [
    'lead generation automation',
    'lead generation automation guide',
    'lead generation automation tutorial',
    ...
    'how to lead generation automation',
    'best lead generation automation solutions',
    'lead generation automation for beginners',
    'lead generation automation step by step guide',
    'lead generation automation automation tools',
    'lead generation automation software comparison',
    'lead generation automation best practices',
    'lead generation automation implementation guide',
    'top lead generation automation platforms',
    'lead generation automation vs alternatives'
  ],
  openGraph: {
    title: 'Lead Generation Automation: Advanced Automation Guide 2025',
    description: 'Comprehensive lead generation automation guide with proven strategies, tools, and case studies.',
    type: 'article',
    publishedTime: '2025-08-03T00:17:13.086Z',
    authors: ['IImagined.ai Team'],
    tags: ['lead generation automation', 'lead generation automation guide', 'lead generation automation tutorial', 'lead generation automation tools', 'lead generation automation software'],
  }
};