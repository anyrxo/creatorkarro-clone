...
export const metadata = {
  ...
  keywords: ["ai influencer analytics","ai influencer analytics guide","ai influencer analytics 2025","ai influencer analytics course","ai influencer analytics training","ai","ai influencer analytics","course","training","guide","2025"],
  ...
  openGraph: {
    title: "Ai Influencer Analytics: Expert Guide 2025",
    description: "ai influencer analytics guide, ai influencer analytics tutorial, ai influencer analytics course - Expert training from the creators of AI Influencers Academy wi",
    url: "https://iimagined.ai/blog/ai-influencer-analytics",
    siteName: "IImagined.ai",
    type: "article",
    publishedTime: "2025-08-05T10:00:00.000Z",
    modifiedTime: "2025-08-05T08:27:05.638Z",
    authors: ["IImagined.ai Expert Team"],
    tags: ["ai influencer analytics","ai influencer analytics guide","ai influencer analytics 2025","ai influencer analytics course","ai influencer analytics training","ai"],
    images: [{
      url: "https://iimagined.ai/images/ai-influencer-analytics-og.jpg",
      width: 1200,
      height: 630,
      alt: "Ai Influencer Analytics: Expert Guide 2025",
      type: "image/jpeg"
    }],
    locale: "en_US"
  },
  ...
  alternates: {
    canonical: "https://iimagined.ai/blog/ai-influencer-analytics"
  }
}
          ...
          <div className="prose prose-invert prose-lg max-w-none">
            ...
            <div className="bg-gradient-to-r from-zinc-900/50 to-zinc-800/50 rounded-2xl p-8 mb-12 border border-zinc-700/50 backdrop-blur-sm">
              ...
              <div className="flex flex-wrap gap-3">
                <span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#ai influencer analytics</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#ai influencer analytics guide</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#ai influencer analytics 2025</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#ai influencer analytics course</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#ai influencer analytics training</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#ai</span>
              </div>
            </div>
