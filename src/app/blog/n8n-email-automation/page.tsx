...
export const metadata = {
  ...
  keywords: ["n8n email automation","n8n email automation guide","n8n email automation 2025","n8n email automation course","n8n email automation training","n8n","n8n email automation","course","training","guide","2025"],
  ...
  openGraph: {
    title: "N8n Email Automation: Expert Guide 2025",
    description: "n8n email automation guide, n8n email automation tutorial, n8n email automation course - Expert training from the creators of N8N Automation Hub with 45K+ stude",
    url: "https://iimagined.ai/blog/n8n-email-automation",
    siteName: "IImagined.ai",
    type: "article",
    publishedTime: "2025-08-05T10:00:00.000Z",
    modifiedTime: "2025-08-05T08:27:05.629Z",
    authors: ["IImagined.ai Expert Team"],
    tags: ["n8n email automation","n8n email automation guide","n8n email automation 2025","n8n email automation course","n8n email automation training","n8n"],
    images: [{
      url: "https://iimagined.ai/images/n8n-email-automation-og.jpg",
      width: 1200,
      height: 630,
      alt: "N8n Email Automation: Expert Guide 2025",
      type: "image/jpeg"
    }],
    locale: "en_US"
  },
  ...
  alternates: {
    canonical: "https://iimagined.ai/blog/n8n-email-automation"
  }
}
          ...
          <div className="prose prose-invert prose-lg max-w-none">
            ...
            <div className="bg-gradient-to-r from-zinc-900/50 to-zinc-800/50 rounded-2xl p-8 mb-12 border border-zinc-700/50 backdrop-blur-sm">
              ...
              <div className="flex flex-wrap gap-3">
                <span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#n8n email automation</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#n8n email automation guide</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#n8n email automation 2025</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#n8n email automation course</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#n8n email automation training</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#n8n</span>
              </div>
            </div>
