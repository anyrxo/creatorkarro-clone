...
export const metadata = {
  ...
  keywords: ["instagram content calendar template","instagram content calendar template guide","instagram content calendar template 2025","instagram content calendar template course","instagram content calendar template training","instagram","instagram content calendar template","course","training","guide","2025"],
  ...
  openGraph: {
    title: "Instagram Content Calendar Template: Expert Guide 2025",
    description: "instagram content calendar template guide, instagram content calendar template tutorial, instagram content calendar template course - Expert training from the c",
    url: "https://iimagined.ai/blog/instagram-content-calendar-template",
    siteName: "IImagined.ai",
    type: "article",
    publishedTime: "2025-08-05T10:00:00.000Z",
    modifiedTime: "2025-08-05T08:27:05.625Z",
    authors: ["IImagined.ai Expert Team"],
    tags: ["instagram content calendar template","instagram content calendar template guide","instagram content calendar template 2025","instagram content calendar template course","instagram content calendar template training","instagram"],
    images: [{
      url: "https://iimagined.ai/images/instagram-content-calendar-template-og.jpg",
      width: 1200,
      height: 630,
      alt: "Instagram Content Calendar Template: Expert Guide 2025",
      type: "image/jpeg"
    }],
    locale: "en_US"
  },
  ...
  alternates: {
    canonical: "https://iimagined.ai/blog/instagram-content-calendar-template"
  }
}
          ...
          <div className="prose prose-invert prose-lg max-w-none">
            ...
            <div className="bg-gradient-to-r from-zinc-900/50 to-zinc-800/50 rounded-2xl p-8 mb-12 border border-zinc-700/50 backdrop-blur-sm">
              ...
              <div className="flex flex-wrap gap-3">
                <span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#instagram content calendar template</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#instagram content calendar template guide</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#instagram content calendar template 2025</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#instagram content calendar template course</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#instagram content calendar template training</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#instagram</span>
              </div>
            </div>
