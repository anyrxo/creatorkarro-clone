  ...
  return (
    <div className="min-h-screen bg-dark">
      ...
      <section 
        ...
        className={`section-spacing bg-zinc-900 scroll-fade-up ${comparisonAnimation.isVisible ? 'visible' : ''}`}
      >
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-5xl">
      ...
      {/* Use Cases */}
      <section 
        ref={useCasesAnimation.elementRef}
        className={`section-spacing scroll-fade-up ${useCasesAnimation.isVisible ? 'visible' : ''}`}
      >
