...
export const metadata = {
  ...
  keywords: ["automation consulting services","automation consulting services guide","automation consulting services 2025","automation consulting services course","automation consulting services training","automation","automation consulting services","course","training","guide","2025"],
  ...
  openGraph: {
    title: "Automation Consulting Services: Expert Guide 2025",
    description: "automation consulting services guide, automation consulting services tutorial, automation consulting services course - Expert training from the creators of AI A",
    url: "https://iimagined.ai/blog/automation-consulting-services",
    siteName: "IImagined.ai",
    type: "article",
    publishedTime: "2025-08-05T10:00:00.000Z",
    modifiedTime: "2025-08-05T08:27:05.621Z",
    authors: ["IImagined.ai Expert Team"],
    tags: ["automation consulting services","automation consulting services guide","automation consulting services 2025","automation consulting services course","automation consulting services training","automation"],
    images: [{
      url: "https://iimagined.ai/images/automation-consulting-services-og.jpg",
      width: 1200,
      height: 630,
      alt: "Automation Consulting Services: Expert Guide 2025",
      type: "image/jpeg"
    }],
    locale: "en_US"
  },
  ...
  alternates: {
    canonical: "https://iimagined.ai/blog/automation-consulting-services"
  }
}
          ...
          <div className="prose prose-invert prose-lg max-w-none">
            ...
            <div className="bg-gradient-to-r from-zinc-900/50 to-zinc-800/50 rounded-2xl p-8 mb-12 border border-zinc-700/50 backdrop-blur-sm">
              ...
              <div className="flex flex-wrap gap-3">
                <span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#automation consulting services</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#automation consulting services guide</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#automation consulting services 2025</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#automation consulting services course</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#automation consulting services training</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#automation</span>
              </div>
            </div>
