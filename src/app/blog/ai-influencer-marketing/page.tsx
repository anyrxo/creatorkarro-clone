...
export const metadata = {
  ...
  keywords: ["ai influencer marketing","ai influencer marketing guide","ai influencer marketing 2025","ai influencer marketing course","ai influencer marketing training","ai","ai influencer marketing","course","training","guide","2025"],
  ...
  openGraph: {
    title: "Ai Influencer Marketing: Expert Guide 2025",
    description: "ai influencer marketing guide, ai influencer marketing tutorial, ai influencer marketing course - Expert training from the creators of AI Influencers Academy wi",
    url: "https://iimagined.ai/blog/ai-influencer-marketing",
    siteName: "IImagined.ai",
    type: "article",
    publishedTime: "2025-08-05T10:00:00.000Z",
    modifiedTime: "2025-08-05T08:27:05.637Z",
    authors: ["IImagined.ai Expert Team"],
    tags: ["ai influencer marketing","ai influencer marketing guide","ai influencer marketing 2025","ai influencer marketing course","ai influencer marketing training","ai"],
    images: [{
      url: "https://iimagined.ai/images/ai-influencer-marketing-og.jpg",
      width: 1200,
      height: 630,
      alt: "Ai Influencer Marketing: Expert Guide 2025",
      type: "image/jpeg"
    }],
    locale: "en_US"
  },
  ...
  alternates: {
    canonical: "https://iimagined.ai/blog/ai-influencer-marketing"
  }
}
          ...
          <div className="prose prose-invert prose-lg max-w-none">
            ...
            <div className="bg-gradient-to-r from-zinc-900/50 to-zinc-800/50 rounded-2xl p-8 mb-12 border border-zinc-700/50 backdrop-blur-sm">
              ...
              <div className="flex flex-wrap gap-3">
                <span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#ai influencer marketing</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#ai influencer marketing guide</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#ai influencer marketing 2025</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#ai influencer marketing course</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#ai influencer marketing training</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#ai</span>
              </div>
            </div>
