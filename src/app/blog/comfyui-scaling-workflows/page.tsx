...
export const metadata = {
  ...
  keywords: ["comfyui scaling workflows","comfyui scaling workflows guide","comfyui scaling workflows 2025","comfyui scaling workflows course","comfyui scaling workflows training","comfyui","comfyui scaling workflows","course","training","guide","2025"],
  ...
  openGraph: {
    title: "Comfyui Scaling Workflows: Expert Guide 2025",
    description: "comfyui scaling workflows guide, comfyui scaling workflows tutorial, comfyui scaling workflows course - Expert training from the creators of N8N Automation Hub ",
    url: "https://iimagined.ai/blog/comfyui-scaling-workflows",
    siteName: "IImagined.ai",
    type: "article",
    publishedTime: "2025-08-05T10:00:00.000Z",
    modifiedTime: "2025-08-05T08:27:05.635Z",
    authors: ["IImagined.ai Expert Team"],
    tags: ["comfyui scaling workflows","comfyui scaling workflows guide","comfyui scaling workflows 2025","comfyui scaling workflows course","comfyui scaling workflows training","comfyui"],
    images: [{
      url: "https://iimagined.ai/images/comfyui-scaling-workflows-og.jpg",
      width: 1200,
      height: 630,
      alt: "Comfyui Scaling Workflows: Expert Guide 2025",
      type: "image/jpeg"
    }],
    locale: "en_US"
  },
  ...
  alternates: {
    canonical: "https://iimagined.ai/blog/comfyui-scaling-workflows"
  }
}
          ...
          <div className="prose prose-invert prose-lg max-w-none">
            ...
            <div className="bg-gradient-to-r from-zinc-900/50 to-zinc-800/50 rounded-2xl p-8 mb-12 border border-zinc-700/50 backdrop-blur-sm">
              ...
              <div className="flex flex-wrap gap-3">
                <span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#comfyui scaling workflows</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#comfyui scaling workflows guide</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#comfyui scaling workflows 2025</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#comfyui scaling workflows course</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#comfyui scaling workflows training</span><span className="bg-zinc-800/60 text-zinc-300 px-3 py-1 rounded-full text-sm border border-zinc-600/30">#comfyui</span>
              </div>
            </div>
