...
export const metadata = {
  ...
  description: "Complete guide to pinterest automation marketing - proven strategies, tools, and techniques for 2026",
  keywords: ["pinterest", "automation", "marketing", "pinterest 2026", "pinterest automation marketing", "AI tools", "business growth", "productivity", "2026 strategies"],
