...
export const metadata: Metadata = {
  title: 'Top ai automation Course | New York | IImagined.ai',
  description: 'Master ai automation course in New York. Join 339+ successful students with our proven system. 90% success rate, lifetime access.',
  keywords: 'top ai-automation-course new-york, ai-automation-course course new-york, ai-automation-course training new-york, learn ai-automation-course new-york, new-york ai-automation-course expert, online ai-automation-course course',
  openGraph: {
    title: 'Top ai automation Course in New York',
    description: 'Master ai automation course in New York. Join 339+ successful students with our proven system. 90% success rate, lifetime access.',
    images: [{ url: '/og-geo-top-ai-automation-course-new-york.jpg', width: 1200, height: 630 }]
  }
}

export default function TopAiAutomationCourseNewYorkPage() {
  ...
  const jsonLd = {
    ...
    '@type': ['Service', 'Course'],
    'name': 'Top ai automation course Training in New York',
    ...
    <div className="min-h-screen bg-dark">
      ...
      <BreadcrumbSchema 
        items={[
          ...
          { name: 'New York', url: 'https://iimagined.ai/top-ai-automation-course-new-york' }
        ]}
      />
        ...
        <div className="container mx-auto max-w-6xl relative z-10">
          ...
          >
            ...
            <h1 className="text-5xl md:text-7xl font-bold text-white mb-6 leading-tight">
              Top ai automation Course
            </h1>
            
            <p className="text-xl md:text-2xl text-zinc-300 mb-8 max-w-4xl mx-auto leading-relaxed">
              Join 339+ entrepreneurs in New York who have mastered ai automation course with our battle-tested strategies and achieved real results.
            </p>
