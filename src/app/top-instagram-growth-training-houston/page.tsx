...
export const metadata: Metadata = {
  title: 'Top instagram growth Course | Houston | IImagined.ai',
  description: 'Master instagram growth training in Houston. Join 495+ successful students with our proven system. 90% success rate, lifetime access.',
  keywords: 'top instagram-growth-training houston, instagram-growth-training course houston, instagram-growth-training training houston, learn instagram-growth-training houston, houston instagram-growth-training expert, online instagram-growth-training course',
  openGraph: {
    title: 'Top instagram growth Course in Houston',
    description: 'Master instagram growth training in Houston. Join 495+ successful students with our proven system. 90% success rate, lifetime access.',
        ...
        <div className="container mx-auto max-w-6xl relative z-10">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-zinc-300 mb-8 max-w-4xl mx-auto leading-relaxed">
              Join 495+ entrepreneurs in Houston who have mastered instagram growth training with our battle-tested strategies and achieved real results.
            </p>
