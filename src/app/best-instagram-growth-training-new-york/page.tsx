...
export const metadata: Metadata = {
  title: 'Best instagram growth Course | New York | IImagined.ai',
  description: 'Master instagram growth training in New York. Join 461+ successful students with our proven system. 90% success rate, lifetime access.',
  keywords: 'best instagram-growth-training new-york, instagram-growth-training course new-york, instagram-growth-training training new-york, learn instagram-growth-training new-york, new-york instagram-growth-training expert, online instagram-growth-training course',
  openGraph: {
    title: 'Best instagram growth Course in New York',
    description: 'Master instagram growth training in New York. Join 461+ successful students with our proven system. 90% success rate, lifetime access.',
        ...
        <div className="container mx-auto max-w-6xl relative z-10">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-zinc-300 mb-8 max-w-4xl mx-auto leading-relaxed">
              Join 461+ entrepreneurs in New York who have mastered instagram growth training with our battle-tested strategies and achieved real results.
            </p>
