...
export const metadata: Metadata = {
  "title": "Coursera vs IImagined.ai: Which is Better? [2025 Comparison] | IImagined.ai",
  "description": "Complete Coursera vs IImagined.ai comparison. See why 127K+ students choose IImagined.ai for guaranteed results and better ROI.",
  "keywords": "Coursera vs IImagined.ai, Coursera vs IImagined.ai course, Coursera vs IImagined.ai training, learn Coursera vs IImagined.ai, Coursera vs IImagined.ai mastery",
  "openGraph": {
    "title": "Coursera vs IImagined.ai: Which is Better? [2025 Comparison] | IImagined.ai",
    "description": "Complete Coursera vs IImagined.ai comparison. See why 127K+ students choose IImagined.ai for guaranteed results and better ROI.",
    "images": [
      {
        "url": "/api/og?title=Coursera%20vs%20IImagined.ai%3A%20Which%20is%20Better%3F%20%5B2025%20Comparison%5D&urgency=true",
        "width": 1200,
        "height": 630,
        "alt": "Coursera vs IImagined.ai: Which is Better? [2025 Comparison] | IImagined.ai"
      }
    ],
    "type": "website",
  ...
  "twitter": {
    ...
    "description": "Complete Coursera vs IImagined.ai comparison. See why 127K+ students choose IImagined.ai for guaranteed results and better ROI.",
    "images": [
      "/api/og?title=Coursera%20vs%20IImagined.ai%3A%20Which%20is%20Better%3F%20%5B2025%20Comparison%5D&urgency=true"
    ]
  },
  "robots": {
    "index": true,
  ...
  "alternates": {
    "canonical": "https://iimagined.ai/coursera-vs-iimagined.ai"
  }
}

export default function CourseraVsIImaginedPage() {
  ...
  const jsonLd = {
    ...
    '@type': 'Product',
    'name': 'IImagined.ai vs Coursera - Complete Comparison',
    'description': 'Detailed comparison between IImagined.ai and Coursera. See why 127K+ students choose IImagined.ai for guaranteed results.',
    'brand': {
      '@type': 'Brand',
      'name': 'IImagined.ai'
    },
      ...
      <section className="py-20 px-4">
        <div className="container mx-auto max-w-6xl text-center">
          <h1 className="text-4xl md:text-6xl font-bold mb-6">
            IImagined.ai vs Coursera: Which is Better?
          </h1>
          <p className="text-xl text-zinc-300 mb-8 max-w-4xl mx-auto">
            ...
            See why 127K+ students choose IImagined.ai over Coursera.
          </p>
        </div>
      </section>
