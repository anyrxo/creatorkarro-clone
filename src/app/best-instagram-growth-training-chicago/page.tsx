...
export const metadata: Metadata = {
  title: 'Best instagram growth Course | Chicago | IImagined.ai',
  description: 'Master instagram growth training in Chicago. Join 385+ successful students with our proven system. 90% success rate, lifetime access.',
  keywords: 'best instagram-growth-training chicago, instagram-growth-training course chicago, instagram-growth-training training chicago, learn instagram-growth-training chicago, chicago instagram-growth-training expert, online instagram-growth-training course',
  openGraph: {
    title: 'Best instagram growth Course in Chicago',
    description: 'Master instagram growth training in Chicago. Join 385+ successful students with our proven system. 90% success rate, lifetime access.',
        ...
        <div className="container mx-auto max-w-6xl relative z-10">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-zinc-300 mb-8 max-w-4xl mx-auto leading-relaxed">
              Join 385+ entrepreneurs in Chicago who have mastered instagram growth training with our battle-tested strategies and achieved real results.
            </p>
