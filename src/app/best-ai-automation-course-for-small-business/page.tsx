...
export const metadata: Metadata = {
  "title": "Best Ai Automation Course for small business [2025 Updated] | IImagined.ai",
  "description": "Find the best Ai Automation Course for small business. Compare top courses, pricing, and results. IImagined.ai rated #1 by 127K+ students.",
  "keywords": "artificial intelligence, machine learning, ai automation, ai tools, ai workflows, ai productivity, ai business solutions, ai integration, ai optimization, ai-powered systems, business automation, workflow automation, process automation, marketing automation, sales automation, productivity automation, automation tools, automation systems, automation strategies, Best Ai Automation Course for small business",
  "openGraph": {
    "title": "Best Ai Automation Course for small business [2025 Updated] | IImagined.ai",
    "description": "Find the best Ai Automation Course for small business. Compare top courses, pricing, and results. IImagined.ai rated #1 by 127K+ students.",
    "images": [
      {
        "url": "/api/og?title=Best%20Ai%20Automation%20Course%20for%20small%20business%20%5B2025%20Updated%5D&urgency=true",
        "width": 1200,
        "height": 630,
        "alt": "Best Ai Automation Course for small business [2025 Updated] | IImagined.ai"
      }
    ],
    "type": "website",
  ...
  "twitter": {
    ...
    "description": "Find the best Ai Automation Course for small business. Compare top courses, pricing, and results. IImagined.ai rated #1 by 127K+ students.",
    "images": [
      "/api/og?title=Best%20Ai%20Automation%20Course%20for%20small%20business%20%5B2025%20Updated%5D&urgency=true"
    ]
  },
  "robots": {
    "index": true,
  ...
  "alternates": {
    "canonical": "https://iimagined.ai/best-ai-automation-course-for-small-business"
  }
}

export default function BestAiAutomationCourseForSmallBusinessPage() {
  const courses = [
    {
      ...
      <section className="py-20 px-4">
        <div className="container mx-auto max-w-6xl">
          <h1 className="text-4xl md:text-6xl font-bold text-center mb-6">
            Best Ai Automation Course for small business [2025]
          </h1>
          <p className="text-xl text-zinc-300 text-center mb-12 max-w-4xl mx-auto">
            We've tested and reviewed the top Ai Automation Courses for small business. 
