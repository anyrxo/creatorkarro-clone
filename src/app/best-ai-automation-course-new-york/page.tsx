...
export const metadata: Metadata = {
  ...
  description: 'Master ai automation course in New York. Join 291+ successful students with our proven system. 90% success rate, lifetime access.',
  keywords: 'best ai-automation-course new-york, ai-automation-course course new-york, ai-automation-course training new-york, learn ai-automation-course new-york, new-york ai-automation-course expert, online ai-automation-course course',
  openGraph: {
        ...
        <div className="container mx-auto max-w-6xl relative z-10">
          ...
          >
            ...
            <h1 className="text-5xl md:text-7xl font-bold text-white mb-6 leading-tight">
              Best ai automation Course
            </h1>
            
            <p className="text-xl md:text-2xl text-zinc-300 mb-8 max-w-4xl mx-auto leading-relaxed">
              Join 291+ entrepreneurs in New York who have mastered ai automation course with our battle-tested strategies and achieved real results.
            </p>
