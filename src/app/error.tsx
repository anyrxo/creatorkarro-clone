...
import { RefreshCcw, Home, ChevronRight } from 'lucide-react'
        ...
        {process.env.NODE_ENV === 'development' && (
          <div className="mb-8 p-6 bg-zinc-900/80 backdrop-blur-sm border border-red-500/30 rounded-xl">
            ...
            <div className="space-y-2">
              ...
              {error.digest && (
                <div>
                  <p className="text-sm font-medium text-zinc-400">Digest:</p>
                  <p className="text-sm text-zinc-300 font-mono bg-black/50 p-3 rounded mt-1">
                    {error.digest}
                  </p>
                </div>
              )}
