...
export const metadata: Metadata = {
  "title": "Udemy vs IImagined.ai: Which is Better? [2025 Comparison] | IImagined.ai",
  "description": "Complete Udemy vs IImagined.ai comparison. See why 127K+ students choose IImagined.ai for guaranteed results and better ROI.",
  "keywords": "Udemy vs IImagined.ai, Udemy vs IImagined.ai course, Udemy vs IImagined.ai training, learn Udemy vs IImagined.ai, Udemy vs IImagined.ai mastery",
  "openGraph": {
    "title": "Udemy vs IImagined.ai: Which is Better? [2025 Comparison] | IImagined.ai",
    "description": "Complete Udemy vs IImagined.ai comparison. See why 127K+ students choose IImagined.ai for guaranteed results and better ROI.",
    "images": [
      {
        "url": "/api/og?title=Udemy%20vs%20IImagined.ai%3A%20Which%20is%20Better%3F%20%5B2025%20Comparison%5D&urgency=true",
        "width": 1200,
        "height": 630,
        "alt": "Udemy vs IImagined.ai: Which is Better? [2025 Comparison] | IImagined.ai"
      }
    ],
    "type": "website",
  ...
  "twitter": {
    ...
    "description": "Complete Udemy vs IImagined.ai comparison. See why 127K+ students choose IImagined.ai for guaranteed results and better ROI.",
    "images": [
      "/api/og?title=Udemy%20vs%20IImagined.ai%3A%20Which%20is%20Better%3F%20%5B2025%20Comparison%5D&urgency=true"
    ]
  },
  "robots": {
    "index": true,
  ...
  "alternates": {
    "canonical": "https://iimagined.ai/udemy-vs-iimagined.ai"
  }
}

export default function UdemyVsIImaginedPage() {
  ...
  const jsonLd = {
    ...
    '@type': 'Product',
    'name': 'IImagined.ai vs Udemy - Complete Comparison',
    'description': 'Detailed comparison between IImagined.ai and Udemy. See why 127K+ students choose IImagined.ai for guaranteed results.',
    'brand': {
      '@type': 'Brand',
      'name': 'IImagined.ai'
    },
      ...
      <section className="py-20 px-4">
        <div className="container mx-auto max-w-6xl text-center">
          <h1 className="text-4xl md:text-6xl font-bold mb-6">
            IImagined.ai vs Udemy: Which is Better?
          </h1>
          <p className="text-xl text-zinc-300 mb-8 max-w-4xl mx-auto">
            ...
            See why 127K+ students choose IImagined.ai over Udemy.
          </p>
        </div>
      </section>
