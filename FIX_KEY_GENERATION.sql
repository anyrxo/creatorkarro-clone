-- IMPORTANT: Run this in your Supabase SQL Editor to fix the Key Generation Error
-- This adds the missing 'expires_at' column that is causing the admin dashboard to fail.

ALTER TABLE public.license_keys 
ADD COLUMN IF NOT EXISTS expires_at timestamp with time zone;

-- Also ensure the claim function handles it correctly
