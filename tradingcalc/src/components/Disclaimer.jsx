        ...
        <div className="flex items-start gap-3">
          ...
          <div className="space-y-3 text-sm">
            ...
            <div className="text-gray-300 space-y-2 leading-relaxed">
              <p>
                <strong className="text-orange-300">⚠️ Risk Warning:</strong> This IIMAGINED Trading Calculator is provided for <strong>educational purposes only</strong>. 
              ...
              <p>
                <strong className="text-blue-300">🚫 No Liability:</strong> <strong>iimagined.ai</strong>, <strong>Anyro</strong>, <strong>@anyrxo</strong>, and all associated entities 
            ...
            <div className="flex items-center gap-2 pt-2 border-t border-red-500/20">
              ...
              <span className="text-xs text-gray-400">
                ...
                For support and feedback: <a href="https://help.manus.im" className="text-blue-400 hover:text-blue-300">help.manus.im</a>
              </span>
            </div>
          </div>
        </div>
