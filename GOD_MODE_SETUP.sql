...
-- RLS: Service Role has full access (handled by your admin scripts)
-- We generally don't want public users reading this table directly, 
-- but we might allow authenticated users to see their own keys.
